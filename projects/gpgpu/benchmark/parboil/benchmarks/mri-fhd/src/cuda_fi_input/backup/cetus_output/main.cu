...
int original_numK;
/* Number of K values in input file */
float * kx, * ky, * kz;
...
/* RhoPhi values (complex) */
float * outI, * outR;
/* Output signal (complex) */
kValues * kVals;
/*
Copy of X and RhoPhi.  Its
