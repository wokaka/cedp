...
//[GPUFI]texture<float4, 1, cudaReadModeElementType> texCoors;
//[GPUFI]texture<float2, 1, cudaReadModeElementType> texSprms;
//[GPUFI]texture<float , 1, cudaReadModeElementType> texWghts;
