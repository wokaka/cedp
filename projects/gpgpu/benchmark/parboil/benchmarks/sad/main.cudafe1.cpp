...
extern "C" { extern inline intmax_t strtoimax(const char *__restrict__, char **__restrict__, int) throw() __attribute__((__gnu_inline__)); } 



extern "C" { extern inline uintmax_t strtoumax(const char *__restrict__, char **__restrict__, int) throw() __attribute__((__gnu_inline__)); } 



extern "C" { extern inline intmax_t wcstoimax(const wchar_t *__restrict__, wchar_t **__restrict__, int) throw() __attribute__((__gnu_inline__)); } 




extern "C" { extern inline uintmax_t wcstoumax(const wchar_t *__restrict__, wchar_t **__restrict__, int) throw() __attribute__((__gnu_inline__)); } 
# 380 "/usr/include/inttypes.h" 3
extern "C" long long __strtoll_internal(const char *__restrict__, char **__restrict__, int, int) throw(); 
# 386
extern "C" { inline __attribute__((__gnu_inline__)) intmax_t strtoimax(const char *__restrict__ nptr, char **__restrict__ endptr, int base) throw() 
...
extern "C" unsigned long long __strtoull_internal(const char *__restrict__, char **__restrict__, int, int) throw(); 
# 402
extern "C" { inline __attribute__((__gnu_inline__)) uintmax_t strtoumax(const char *__restrict__ nptr, char **__restrict__ endptr, int base) throw() 
...
extern "C" long long __wcstoll_internal(const wchar_t *__restrict__, wchar_t **__restrict__, int, int) throw(); 
# 416
extern "C" { inline __attribute__((__gnu_inline__)) intmax_t wcstoimax(const wchar_t *__restrict__ nptr, wchar_t **__restrict__ endptr, int base) throw() 
...
extern "C" unsigned long long __wcstoull_internal(const wchar_t *__restrict__, wchar_t **__restrict__, int, int) throw(); 
# 433
extern "C" { inline __attribute__((__gnu_inline__)) uintmax_t wcstoumax(const wchar_t *__restrict__ nptr, wchar_t **__restrict__ endptr, int base) throw() 
...
extern void larger_sad_calc_8__entry(unsigned short *, int, int); 
extern void larger_sad_calc_16__entry(unsigned short *, int, int); 
# 18 "src/cuda_fi/largerBlocks.cu"
struct uhvec { 
...
extern "C" { typedef unsigned uint; }
void larger_sad_calc_8__entry(unsigned short *blk_sad, int mb_width, int mb_height, _gpufi_data_ *gpufi_dev);
#if 0
 
# 27
{ 
GPUFI_KERNEL(gpufi_dev, 0, 0, (char *)("larger_sad_calc_8")); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 0, (char *)("blk_sad"), (int *)(&blk_sad), 50); 


GPUFI_KERNEL_VARIABLE(gpufi_dev, 1, (char *)("mb_width"), (int *)(&mb_width), 10); 


GPUFI_KERNEL_VARIABLE(gpufi_dev, 2, (char *)("mb_height"), (int *)(&mb_height), 10); 


auto int tx = ((threadIdx.y) & (1)); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 6, (char *)("tx"), (int *)(&tx), 10); 


auto int ty = ((threadIdx.y) >> 1); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 7, (char *)("ty"), (int *)(&ty), 10); 



auto int mb_x = (blockIdx.x); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 8, (char *)("mb_x"), (int *)(&mb_x), 10); 


auto int mb_y = (blockIdx.y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 9, (char *)("mb_y"), (int *)(&mb_y), 10); 



auto int macroblocks = __mul24(mb_width, mb_height); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 10, (char *)("macroblocks"), (int *)(&macroblocks), 10); 


auto int macroblock_index = ((__mul24(mb_y, mb_width) + mb_x) * 1096); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 11, (char *)("macroblock_index"), (int *)(&macroblock_index), 10); 


auto int search_pos; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 12, (char *)("search_pos"), (int *)(&search_pos), 10); 


auto unsigned short *bi; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 13, (char *)("bi"), (int *)(&bi), 50); 


auto unsigned short *bo_6; auto unsigned short *bo_5; auto unsigned short *bo_4; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 14, (char *)("bo_6"), (int *)(&bo_6), 50); 


bi = (blk_sad + (__mul24(macroblocks, 25) + (ty * 8 + tx * 2)) * 1096) + macroblock_index * 16; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 15, (char *)("bi"), (int *)(&bi), 50); 
# 82 "src/cuda_fi/largerBlocks.cu"
bo_6 = (blk_sad + (((macroblocks << 4) + macroblocks) + (ty * 4 + tx * 2)) * 1096) + macroblock_index * 8; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 16, (char *)("bo_6"), (int *)(&bo_6), 50); 
...
GPUFI_KERNEL_VARIABLE(gpufi_dev, 17, (char *)("bo_5"), (int *)(&bo_5), 50); 
# 98 "src/cuda_fi/largerBlocks.cu"
bo_4 = (blk_sad + (((macroblocks << 2) + macroblocks) + (ty * 2 + tx)) * 1096) + macroblock_index * 4; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 18, (char *)("bo_4"), (int *)(&bo_4), 50); 
...
auto uint i00 = (((uint *)bi)[search_pos]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 21, (char *)("i00"), (int *)(&i00), 0); 


auto uint i01 = (((uint *)bi)[search_pos + (1096 / 2)]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 22, (char *)("i01"), (int *)(&i01), 0); 


auto uint i10 = (((uint *)bi)[search_pos + ((4 * 1096) / 2)]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 23, (char *)("i10"), (int *)(&i10), 0); 


auto uint i11 = (((uint *)bi)[search_pos + ((5 * 1096) / 2)]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 24, (char *)("i11"), (int *)(&i11), 0); 


(((uint *)bo_6)[search_pos]) = i00 + i10; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 25, (char *)("((uint * )bo_6)[search_pos]"), (int *)((uint *)bo_6 + search_pos), 0); 


(((uint *)bo_6)[search_pos + (1096 / 2)]) = i01 + i11; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 26, (char *)("((uint * )bo_6)[(search_pos+(1096/2))]"), (int *)((uint *)bo_6 + (search_pos + (1096 / 2))), 0); 


(((uint *)bo_5)[search_pos]) = i00 + i01; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 27, (char *)("((uint * )bo_5)[search_pos]"), (int *)((uint *)bo_5 + search_pos), 0); 


(((uint *)bo_5)[search_pos + ((2 * 1096) / 2)]) = i10 + i11; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 28, (char *)("((uint * )bo_5)[(search_pos+((2*1096)/2))]"), (int *)((uint *)bo_5 + (search_pos + ((2 * 1096) / 2))), 0); 


(((uint *)bo_4)[search_pos]) = (i00 + i01) + (i10 + i11); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 29, (char *)("((uint * )bo_4)[search_pos]"), (int *)((uint *)bo_4 + search_pos), 0); 
...
GPUFI_KERNEL_VARIABLE(gpufi_dev, 20, (char *)("search_pos"), (int *)(&search_pos), 10); 


GPUFI_KERNEL(gpufi_dev, 1, 0, (char *)("larger_sad_calc_8")); 
} 
#endif
# 165 "src/cuda_fi/largerBlocks.cu"
void larger_sad_calc_16__entry(unsigned short *blk_sad, int mb_width, int mb_height, _gpufi_data_ *gpufi_dev);
#if 0
 
# 166
{ 
GPUFI_KERNEL(gpufi_dev, 0, 1, (char *)("larger_sad_calc_16")); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 3, (char *)("blk_sad"), (int *)(&blk_sad), 50); 


GPUFI_KERNEL_VARIABLE(gpufi_dev, 4, (char *)("mb_width"), (int *)(&mb_width), 10); 


GPUFI_KERNEL_VARIABLE(gpufi_dev, 5, (char *)("mb_height"), (int *)(&mb_height), 10); 



auto int mb_x = (blockIdx.x); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 30, (char *)("mb_x"), (int *)(&mb_x), 10); 


auto int mb_y = (blockIdx.y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 31, (char *)("mb_y"), (int *)(&mb_y), 10); 



auto int macroblocks = (__mul24(mb_width, mb_height) * 1096); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 32, (char *)("macroblocks"), (int *)(&macroblocks), 10); 


auto int macroblock_index = ((__mul24(mb_y, mb_width) + mb_x) * 1096); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 33, (char *)("macroblock_index"), (int *)(&macroblock_index), 10); 


auto int search_pos; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 34, (char *)("search_pos"), (int *)(&search_pos), 10); 


auto unsigned short *bi; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 35, (char *)("bi"), (int *)(&bi), 50); 


auto unsigned short *bo_3; auto unsigned short *bo_2; auto unsigned short *bo_1; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 36, (char *)("bo_3"), (int *)(&bo_3), 50); 
# 209 "src/cuda_fi/largerBlocks.cu"
bi = (blk_sad + ((macroblocks + macroblock_index) << 2)) + macroblocks; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 37, (char *)("bi"), (int *)(&bi), 50); 
# 217 "src/cuda_fi/largerBlocks.cu"
bo_3 = (blk_sad + ((macroblocks + macroblock_index) << 1)) + macroblocks; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 38, (char *)("bo_3"), (int *)(&bo_3), 50); 
# 223 "src/cuda_fi/largerBlocks.cu"
bo_2 = (blk_sad + macroblocks) + macroblock_index * 2; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 39, (char *)("bo_2"), (int *)(&bo_2), 50); 
# 229 "src/cuda_fi/largerBlocks.cu"
bo_1 = blk_sad + macroblock_index; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 40, (char *)("bo_1"), (int *)(&bo_1), 50); 
...
auto uint i00 = (((uint *)bi)[search_pos]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 43, (char *)("i00"), (int *)(&i00), 0); 


auto uint i01 = (((uint *)bi)[search_pos + (1096 / 2)]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 44, (char *)("i01"), (int *)(&i01), 0); 


auto uint i10 = (((uint *)bi)[search_pos + ((2 * 1096) / 2)]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 45, (char *)("i10"), (int *)(&i10), 0); 


auto uint i11 = (((uint *)bi)[search_pos + ((3 * 1096) / 2)]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 46, (char *)("i11"), (int *)(&i11), 0); 


(((uint *)bo_3)[search_pos]) = i00 + i10; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 47, (char *)("((uint * )bo_3)[search_pos]"), (int *)((uint *)bo_3 + search_pos), 0); 


(((uint *)bo_3)[search_pos + (1096 / 2)]) = i01 + i11; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 48, (char *)("((uint * )bo_3)[(search_pos+(1096/2))]"), (int *)((uint *)bo_3 + (search_pos + (1096 / 2))), 0); 


(((uint *)bo_2)[search_pos]) = i00 + i01; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 49, (char *)("((uint * )bo_2)[search_pos]"), (int *)((uint *)bo_2 + search_pos), 0); 


(((uint *)bo_2)[search_pos + (1096 / 2)]) = i10 + i11; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 50, (char *)("((uint * )bo_2)[(search_pos+(1096/2))]"), (int *)((uint *)bo_2 + (search_pos + (1096 / 2))), 0); 


(((uint *)bo_1)[search_pos]) = (i00 + i01) + (i10 + i11); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 51, (char *)("((uint * )bo_1)[search_pos]"), (int *)((uint *)bo_1 + search_pos), 0); 
...
GPUFI_KERNEL_VARIABLE(gpufi_dev, 42, (char *)("search_pos"), (int *)(&search_pos), 10); 


GPUFI_KERNEL(gpufi_dev, 1, 1, (char *)("larger_sad_calc_16")); 
} 
#endif
# 72 "src/cuda_fi/sad.h"
extern "C" void sad4_cpu(unsigned short *, unsigned short *, unsigned short *, int, int); 
...
__loc_sc__(__text__,,) texture< unsigned short, 2, cudaReadModeElementType>  ref; 
...
void mb_sad_calc__entry(unsigned short *blk_sad, unsigned short *frame, int mb_width, int mb_height, _gpufi_data_ *gpufi_dev);
#if 0
 
# 60
{ 
GPUFI_KERNEL(gpufi_dev, 0, 0, (char *)("mb_sad_calc")); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 0, (char *)("blk_sad"), (int *)(&blk_sad), 50); 


GPUFI_KERNEL_VARIABLE(gpufi_dev, 1, (char *)("frame"), (int *)(&frame), 50); 


GPUFI_KERNEL_VARIABLE(gpufi_dev, 2, (char *)("mb_width"), (int *)(&mb_width), 10); 


GPUFI_KERNEL_VARIABLE(gpufi_dev, 3, (char *)("mb_height"), (int *)(&mb_height), 10); 


auto int txy_tmp = (threadIdx.x / ((1089 + (18 - 1)) / 18)); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 4, (char *)("txy_tmp"), (int *)(&txy_tmp), 10); 


auto int ty = (txy_tmp / 1); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 5, (char *)("ty"), (int *)(&ty), 10); 


auto int tx = (txy_tmp - __umul24(ty, 1)); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 6, (char *)("tx"), (int *)(&tx), 10); 


auto int bx = (blockIdx.x); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 7, (char *)("bx"), (int *)(&bx), 10); 


auto int by = (blockIdx.y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 8, (char *)("by"), (int *)(&by), 10); 



auto int mb_x = ((tx + __umul24(bx, 1)) >> 2); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 9, (char *)("mb_x"), (int *)(&mb_x), 10); 


auto int mb_y = ((ty + __umul24(by, 1)) >> 2); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 10, (char *)("mb_y"), (int *)(&mb_y), 10); 


auto int block_x = ((tx + __umul24(bx, 1)) & (3)); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 11, (char *)("block_x"), (int *)(&block_x), 10); 


auto int block_y = ((ty + __umul24(by, 1)) & (3)); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 12, (char *)("block_y"), (int *)(&block_y), 10); 
# 115 "src/cuda_fi/sad4.cu"
if (((threadIdx.x) >> 4) < (1 * 1)) 
{ 
auto int ty = (((threadIdx.x) >> 4) / (1)); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 13, (char *)("ty"), (int *)(&ty), 10); 


auto int tx = (((threadIdx.x) >> 4) - __umul24(ty, 1)); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 14, (char *)("tx"), (int *)(&tx), 10); 


auto int tgroup = ((threadIdx.x) & (15)); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 15, (char *)("tgroup"), (int *)(&tgroup), 10); 



auto int img_width = (mb_width * 16); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 16, (char *)("img_width"), (int *)(&img_width), 10); 



auto int frame_x = ((tx + __umul24(bx, 1)) << 2); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 17, (char *)("frame_x"), (int *)(&frame_x), 10); 


auto int frame_y = ((ty + __umul24(by, 1)) << 2); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 18, (char *)("frame_y"), (int *)(&frame_y), 10); 



auto int cur_o = (frame_y * img_width + frame_x); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 19, (char *)("cur_o"), (int *)(&cur_o), 10); 
...
GPUFI_KERNEL_VARIABLE(gpufi_dev, 20, (char *)("frame_loc[(((__umul24(ty, 1)+tx)<<4)+tgroup)]"), (int *)((frame_loc) + (((__umul24(ty, 1) + tx) << 4) + tgroup)), 0); 
...
auto int frame_x = (((mb_x << 2) + block_x) << 2); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 21, (char *)("frame_x"), (int *)(&frame_x), 10); 


auto int frame_y = (((mb_y << 2) + block_y) << 2); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 22, (char *)("frame_y"), (int *)(&frame_y), 10); 



auto int ref_x = (frame_x - 16); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 23, (char *)("ref_x"), (int *)(&ref_x), 10); 


auto int ref_y = (frame_y - 16); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 24, (char *)("ref_y"), (int *)(&ref_y), 10); 



auto int cur_o = (ty * 1 + tx); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 25, (char *)("cur_o"), (int *)(&cur_o), 10); 


auto int search_pos; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 26, (char *)("search_pos"), (int *)(&search_pos), 10); 


auto int search_pos_base = ((threadIdx.x % ((1089 + (18 - 1)) / 18)) * (18)); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 27, (char *)("search_pos_base"), (int *)(&search_pos_base), 10); 


auto int search_pos_end = (search_pos_base + 18); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 28, (char *)("search_pos_end"), (int *)(&search_pos_end), 10); 


auto int sotmp = (search_pos_base / ((2 * 16) + 1)); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 29, (char *)("sotmp"), (int *)(&sotmp), 10); 


auto int local_search_off_x = (search_pos_base - ((sotmp << 5) + sotmp)); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 30, (char *)("local_search_off_x"), (int *)(&local_search_off_x), 10); 


auto int search_off_y = (ref_y + sotmp); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 31, (char *)("search_off_y"), (int *)(&search_off_y), 10); 
...
{ 
search_pos_end = 1089; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 32, (char *)("search_pos_end"), (int *)(&search_pos_end), 10); 
...
auto unsigned short sad1 = (0); auto unsigned short sad2 = (0); auto unsigned short sad3 = (0); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 35, (char *)("sad1"), (int *)(&sad1), 0); 


auto int search_off_x = (ref_x + local_search_off_x); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 36, (char *)("search_off_x"), (int *)(&search_off_x), 10); 



auto int y; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 37, (char *)("y"), (int *)(&y), 10); 
# 275 "src/cuda_fi/sad4.cu"
{ 

auto int t; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 38, (char *)("t"), (int *)(&t), 10); 


y = 0; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 39, (char *)("y"), (int *)(&y), 10); 


t = tex2D(ref, search_off_x, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 40, (char *)("t"), (int *)(&t), 10); 


sad1 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 0]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 41, (char *)("sad1"), (int *)(&sad1), 0); 


t = tex2D(ref, search_off_x + 1, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 42, (char *)("t"), (int *)(&t), 10); 


sad1 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 1]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 43, (char *)("sad1"), (int *)(&sad1), 0); 


sad2 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 0]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 44, (char *)("sad2"), (int *)(&sad2), 0); 


t = tex2D(ref, search_off_x + 2, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 45, (char *)("t"), (int *)(&t), 10); 


sad1 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 2]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 46, (char *)("sad1"), (int *)(&sad1), 0); 


sad2 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 1]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 47, (char *)("sad2"), (int *)(&sad2), 0); 


sad3 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 0]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 48, (char *)("sad3"), (int *)(&sad3), 0); 


t = tex2D(ref, search_off_x + 3, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 49, (char *)("t"), (int *)(&t), 10); 


sad1 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 3]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 50, (char *)("sad1"), (int *)(&sad1), 0); 


sad2 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 2]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 51, (char *)("sad2"), (int *)(&sad2), 0); 


sad3 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 1]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 52, (char *)("sad3"), (int *)(&sad3), 0); 


t = tex2D(ref, search_off_x + 4, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 53, (char *)("t"), (int *)(&t), 10); 


sad2 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 3]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 54, (char *)("sad2"), (int *)(&sad2), 0); 


sad3 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 2]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 55, (char *)("sad3"), (int *)(&sad3), 0); 


t = tex2D(ref, search_off_x + 5, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 56, (char *)("t"), (int *)(&t), 10); 


sad3 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 3]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 57, (char *)("sad3"), (int *)(&sad3), 0); 



y = 1; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 58, (char *)("y"), (int *)(&y), 10); 


t = tex2D(ref, search_off_x, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 59, (char *)("t"), (int *)(&t), 10); 


sad1 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 0]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 60, (char *)("sad1"), (int *)(&sad1), 0); 


t = tex2D(ref, search_off_x + 1, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 61, (char *)("t"), (int *)(&t), 10); 


sad1 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 1]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 62, (char *)("sad1"), (int *)(&sad1), 0); 


sad2 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 0]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 63, (char *)("sad2"), (int *)(&sad2), 0); 


t = tex2D(ref, search_off_x + 2, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 64, (char *)("t"), (int *)(&t), 10); 


sad1 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 2]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 65, (char *)("sad1"), (int *)(&sad1), 0); 


sad2 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 1]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 66, (char *)("sad2"), (int *)(&sad2), 0); 


sad3 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 0]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 67, (char *)("sad3"), (int *)(&sad3), 0); 


t = tex2D(ref, search_off_x + 3, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 68, (char *)("t"), (int *)(&t), 10); 


sad1 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 3]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 69, (char *)("sad1"), (int *)(&sad1), 0); 


sad2 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 2]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 70, (char *)("sad2"), (int *)(&sad2), 0); 


sad3 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 1]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 71, (char *)("sad3"), (int *)(&sad3), 0); 


t = tex2D(ref, search_off_x + 4, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 72, (char *)("t"), (int *)(&t), 10); 


sad2 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 3]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 73, (char *)("sad2"), (int *)(&sad2), 0); 


sad3 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 2]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 74, (char *)("sad3"), (int *)(&sad3), 0); 


t = tex2D(ref, search_off_x + 5, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 75, (char *)("t"), (int *)(&t), 10); 


sad3 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 3]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 76, (char *)("sad3"), (int *)(&sad3), 0); 



y = 2; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 77, (char *)("y"), (int *)(&y), 10); 


t = tex2D(ref, search_off_x, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 78, (char *)("t"), (int *)(&t), 10); 


sad1 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 0]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 79, (char *)("sad1"), (int *)(&sad1), 0); 


t = tex2D(ref, search_off_x + 1, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 80, (char *)("t"), (int *)(&t), 10); 


sad1 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 1]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 81, (char *)("sad1"), (int *)(&sad1), 0); 


sad2 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 0]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 82, (char *)("sad2"), (int *)(&sad2), 0); 


t = tex2D(ref, search_off_x + 2, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 83, (char *)("t"), (int *)(&t), 10); 


sad1 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 2]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 84, (char *)("sad1"), (int *)(&sad1), 0); 


sad2 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 1]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 85, (char *)("sad2"), (int *)(&sad2), 0); 


sad3 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 0]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 86, (char *)("sad3"), (int *)(&sad3), 0); 


t = tex2D(ref, search_off_x + 3, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 87, (char *)("t"), (int *)(&t), 10); 


sad1 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 3]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 88, (char *)("sad1"), (int *)(&sad1), 0); 


sad2 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 2]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 89, (char *)("sad2"), (int *)(&sad2), 0); 


sad3 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 1]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 90, (char *)("sad3"), (int *)(&sad3), 0); 


t = tex2D(ref, search_off_x + 4, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 91, (char *)("t"), (int *)(&t), 10); 


sad2 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 3]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 92, (char *)("sad2"), (int *)(&sad2), 0); 


sad3 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 2]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 93, (char *)("sad3"), (int *)(&sad3), 0); 


t = tex2D(ref, search_off_x + 5, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 94, (char *)("t"), (int *)(&t), 10); 


sad3 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 3]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 95, (char *)("sad3"), (int *)(&sad3), 0); 



y = 3; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 96, (char *)("y"), (int *)(&y), 10); 


t = tex2D(ref, search_off_x, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 97, (char *)("t"), (int *)(&t), 10); 


sad1 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 0]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 98, (char *)("sad1"), (int *)(&sad1), 0); 


t = tex2D(ref, search_off_x + 1, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 99, (char *)("t"), (int *)(&t), 10); 


sad1 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 1]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 100, (char *)("sad1"), (int *)(&sad1), 0); 


sad2 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 0]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 101, (char *)("sad2"), (int *)(&sad2), 0); 


t = tex2D(ref, search_off_x + 2, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 102, (char *)("t"), (int *)(&t), 10); 


sad1 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 2]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 103, (char *)("sad1"), (int *)(&sad1), 0); 


sad2 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 1]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 104, (char *)("sad2"), (int *)(&sad2), 0); 


sad3 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 0]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 105, (char *)("sad3"), (int *)(&sad3), 0); 


t = tex2D(ref, search_off_x + 3, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 106, (char *)("t"), (int *)(&t), 10); 


sad1 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 3]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 107, (char *)("sad1"), (int *)(&sad1), 0); 


sad2 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 2]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 108, (char *)("sad2"), (int *)(&sad2), 0); 


sad3 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 1]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 109, (char *)("sad3"), (int *)(&sad3), 0); 


t = tex2D(ref, search_off_x + 4, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 110, (char *)("t"), (int *)(&t), 10); 


sad2 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 3]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 111, (char *)("sad2"), (int *)(&sad2), 0); 


sad3 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 2]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 112, (char *)("sad3"), (int *)(&sad3), 0); 


t = tex2D(ref, search_off_x + 5, search_off_y + y); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 113, (char *)("t"), (int *)(&t), 10); 


sad3 += abs(t - (frame_loc)[((cur_o << 4) + (y << 2)) + 3]); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 114, (char *)("sad3"), (int *)(&sad3), 0); 


} 

((sad_loc)[(__umul24(ty, 1) + tx) * (1096) + search_pos]) = sad1; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 115, (char *)("sad_loc[(((__umul24(ty, 1)+tx)*1096)+search_pos)]"), (int *)((sad_loc) + ((__umul24(ty, 1) + tx) * (1096) + search_pos)), 0); 


((sad_loc)[(__umul24(ty, 1) + tx) * (1096) + (search_pos + 1)]) = sad2; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 116, (char *)("sad_loc[(((__umul24(ty, 1)+tx)*1096)+(search_pos+1))]"), (int *)((sad_loc) + ((__umul24(ty, 1) + tx) * (1096) + (search_pos + 1))), 0); 


((sad_loc)[(__umul24(ty, 1) + tx) * (1096) + (search_pos + 2)]) = sad3; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 117, (char *)("sad_loc[(((__umul24(ty, 1)+tx)*1096)+(search_pos+2))]"), (int *)((sad_loc) + ((__umul24(ty, 1) + tx) * (1096) + (search_pos + 2))), 0); 


local_search_off_x += 3; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 118, (char *)("local_search_off_x"), (int *)(&local_search_off_x), 10); 


if (local_search_off_x >= ((2 * 16) + 1)) 
{ 
local_search_off_x -= ((2 * 16) + 1); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 119, (char *)("local_search_off_x"), (int *)(&local_search_off_x), 10); 


search_off_y++; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 120, (char *)("search_off_y"), (int *)(&search_off_y), 10); 
...
{ 
auto int tgroup = ((threadIdx.x) & (31)); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 121, (char *)("tgroup"), (int *)(&tgroup), 10); 


auto int ty = (((threadIdx.x) >> 5) / (1)); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 122, (char *)("ty"), (int *)(&ty), 10); 


auto int tx = (((threadIdx.x) >> 5) - __umul24(ty, 1)); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 123, (char *)("tx"), (int *)(&tx), 10); 


auto int index; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 124, (char *)("index"), (int *)(&index), 10); 



auto int mb_x = ((tx + __umul24(bx, 1)) >> 2); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 125, (char *)("mb_x"), (int *)(&mb_x), 10); 


auto int mb_y = ((ty + __umul24(by, 1)) >> 2); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 126, (char *)("mb_y"), (int *)(&mb_y), 10); 


auto int block_x = ((tx + __umul24(bx, 1)) & (3)); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 127, (char *)("block_x"), (int *)(&block_x), 10); 


auto int block_y = ((ty + __umul24(by, 1)) & (3)); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 128, (char *)("block_y"), (int *)(&block_y), 10); 
...
GPUFI_KERNEL_VARIABLE(gpufi_dev, 129, (char *)("blk_sad"), (int *)(&blk_sad), 50); 
...
(((vec8b *)blk_sad)[index]) = (sad_loc_8b)[(__umul24(ty, 1) + tx) * (1096 / 4) + index]; 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 132, (char *)("((struct vec8b * )blk_sad)[index]"), (int *)((vec8b *)blk_sad + index), 0); 
...
GPUFI_KERNEL_VARIABLE(gpufi_dev, 131, (char *)("index"), (int *)(&index), 10); 


}  
}  
GPUFI_KERNEL(gpufi_dev, 1, 0, (char *)("mb_sad_calc")); 
} 
#endif
# 705 "src/cuda_fi/sad4.cu"
texture< unsigned short, 2, cudaReadModeElementType>  &get_ref() 
{ 
return ref; 
} 
# 43 "src/cuda_fi/main.cu"
...
{ 
auto FILE *infile; 
auto unsigned short *sads; 
auto int w; 
auto int h; 
auto int sads_per_block; 
...
{ 
auto int index = ((block * 16 + subblock) * 1096 + sad_index); 
...
{ 
auto unsigned short *vec = (subblock_array + (block + macroblock * count) * 1096); 
...
{ 
auto FILE *outfile = fopen(filename, "w"); 
auto int block; 
if (outfile == (__null)) 
{ 
...
{ 
auto image_i16 *ref_image; 
auto image_i16 *cur_image; 
auto unsigned short *sads_computed; 

GPUFI_INIT(3, 185); 


auto int image_size_bytes; 
auto int image_width_macroblocks; auto int image_height_macroblocks; 
auto int image_size_macroblocks; 
...
{ 
auto cudaArray *ref_ary; 

auto short *d_cur_image; 

auto unsigned short *d_sads; 

auto dim3 macroblock_grid(image_width_macroblocks, image_height_macroblocks); 
...
{ auto cudaError_t err; if ((err = cudaGetLastError()) != (cudaSuccess)) { fprintf(stderr, "CUDA error on line %d: %s\n", 317, cudaGetErrorString(err)); exit(-1); }  } 
cudaMemcpy(__shadow_var(,gpufi_dev), &gpufi_host, sizeof(_gpufi_data_), cudaMemcpyHostToDevice); 
{ auto cudaError_t err; if ((err = cudaGetLastError()) != (cudaSuccess)) { fprintf(stderr, "CUDA error on line %d: %s\n", 319, cudaGetErrorString(err)); exit(-1); }  } 


cudaConfigureCall(dim3((ref_image->width / 4 + (1 - 1)) / 1, (ref_image->height / 4 + (1 - 1)) / 1), ((dim3)((((1089 + (18 - 1)) / 18) * 1) * 1)), ((1 * 1) * 1096) * sizeof(unsigned short)) ? ((void)0) : mb_sad_calc__entry(d_sads, (unsigned short *)d_cur_image, image_width_macroblocks, image_height_macroblocks, __shadow_var(,gpufi_dev)); 

cudaMemcpy(&gpufi_host, __shadow_var(,gpufi_dev), sizeof(_gpufi_data_), cudaMemcpyDeviceToHost); 
{ auto cudaError_t err; if ((err = cudaGetLastError()) != (cudaSuccess)) { fprintf(stderr, "CUDA error on line %d: %s\n", 325, cudaGetErrorString(err)); exit(-1); }  } 
cudaFree(__shadow_var(,gpufi_dev)); 
{ auto cudaError_t err; if ((err = cudaGetLastError()) != (cudaSuccess)) { fprintf(stderr, "CUDA error on line %d: %s\n", 327, cudaGetErrorString(err)); exit(-1); }  } 
...
cudaMalloc((void **)(&__shadow_var(,gpufi_dev)), sizeof(_gpufi_data_)); 
{ auto cudaError_t err; if ((err = cudaGetLastError()) != (cudaSuccess)) { fprintf(stderr, "CUDA error on line %d: %s\n", 340, cudaGetErrorString(err)); exit(-1); }  } 
cudaMemcpy(__shadow_var(,gpufi_dev), &gpufi_host, sizeof(_gpufi_data_), cudaMemcpyHostToDevice); 
{ auto cudaError_t err; if ((err = cudaGetLastError()) != (cudaSuccess)) { fprintf(stderr, "CUDA error on line %d: %s\n", 342, cudaGetErrorString(err)); exit(-1); }  } 


cudaConfigureCall(macroblock_grid, dim3(32, 4)) ? ((void)0) : (larger_sad_calc_8__entry)(d_sads, image_width_macroblocks, image_height_macroblocks, __shadow_var(,gpufi_dev)); 

cudaMemcpy(&gpufi_host, __shadow_var(,gpufi_dev), sizeof(_gpufi_data_), cudaMemcpyDeviceToHost); 
{ auto cudaError_t err; if ((err = cudaGetLastError()) != (cudaSuccess)) { fprintf(stderr, "CUDA error on line %d: %s\n", 348, cudaGetErrorString(err)); exit(-1); }  } 
cudaFree(__shadow_var(,gpufi_dev)); 
{ auto cudaError_t err; if ((err = cudaGetLastError()) != (cudaSuccess)) { fprintf(stderr, "CUDA error on line %d: %s\n", 350, cudaGetErrorString(err)); exit(-1); }  } 
...
cudaMalloc((void **)(&__shadow_var(,gpufi_dev)), sizeof(_gpufi_data_)); 
{ auto cudaError_t err; if ((err = cudaGetLastError()) != (cudaSuccess)) { fprintf(stderr, "CUDA error on line %d: %s\n", 362, cudaGetErrorString(err)); exit(-1); }  } 
cudaMemcpy(__shadow_var(,gpufi_dev), &gpufi_host, sizeof(_gpufi_data_), cudaMemcpyHostToDevice); 
{ auto cudaError_t err; if ((err = cudaGetLastError()) != (cudaSuccess)) { fprintf(stderr, "CUDA error on line %d: %s\n", 364, cudaGetErrorString(err)); exit(-1); }  } 


cudaConfigureCall(macroblock_grid, dim3(32, 1)) ? ((void)0) : (larger_sad_calc_16__entry)(d_sads, image_width_macroblocks, image_height_macroblocks, __shadow_var(,gpufi_dev)); 

cudaMemcpy(&gpufi_host, __shadow_var(,gpufi_dev), sizeof(_gpufi_data_), cudaMemcpyDeviceToHost); 
{ auto cudaError_t err; if ((err = cudaGetLastError()) != (cudaSuccess)) { fprintf(stderr, "CUDA error on line %d: %s\n", 370, cudaGetErrorString(err)); exit(-1); }  } 
cudaFree(__shadow_var(,gpufi_dev)); 
{ auto cudaError_t err; if ((err = cudaGetLastError()) != (cudaSuccess)) { fprintf(stderr, "CUDA error on line %d: %s\n", 372, cudaGetErrorString(err)); exit(-1); }  } 
