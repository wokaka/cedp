...
# 67 "/usr/local/cuda/bin/../include/texture_fetch_functions.h"
/*DEVICE_BUILTIN*/extern __attribute__((__device__)) uint4 __utexfetch(__texture_type__, float4, int);
# 19 "src/cuda/largerBlocks.cu"
__attribute__((__global__)) extern void _Z17larger_sad_calc_8Ptii(unsigned short *, int, int);
# 79 "src/cuda/largerBlocks.cu"
__attribute__((__global__)) extern void _Z18larger_sad_calc_16Ptii(unsigned short *, int, int);
...
# 82 "src/cuda/largerBlocks.cu" 2
# 19 "src/cuda/largerBlocks.cu"
__attribute__((__global__)) void _Z17larger_sad_calc_8Ptii(
# 19 "src/cuda/largerBlocks.cu"
unsigned short *blk_sad,
# 20 "src/cuda/largerBlocks.cu"
int mb_width,
# 21 "src/cuda/largerBlocks.cu"
int mb_height){
# 22 "src/cuda/largerBlocks.cu"
{
# 23 "src/cuda/largerBlocks.cu"
auto int tx;
# 24 "src/cuda/largerBlocks.cu"
auto int ty;
# 27 "src/cuda/largerBlocks.cu"
auto int mb_x;
# 28 "src/cuda/largerBlocks.cu"
auto int mb_y;
# 31 "src/cuda/largerBlocks.cu"
auto int macroblocks;
# 32 "src/cuda/largerBlocks.cu"
auto int macroblock_index;
# 34 "src/cuda/largerBlocks.cu"
auto int search_pos;
# 36 "src/cuda/largerBlocks.cu"
auto unsigned short *bi;
# 37 "src/cuda/largerBlocks.cu"
...
# 39 "src/cuda/largerBlocks.cu"
bi = ((blk_sad + (((__mul24(macroblocks, 25)) + ((ty * 8) + (tx * 2))) * 1096)) + (macroblock_index * 16));
# 44 "src/cuda/largerBlocks.cu"
bo_6 = ((blk_sad + ((((macroblocks << 4) + macroblocks) + ((ty * 4) + (tx * 2))) * 1096)) + (macroblock_index * 8));
# 48 "src/cuda/largerBlocks.cu"
if (ty < 100)
# 49 "src/cuda/largerBlocks.cu"
{
# 51 "src/cuda/largerBlocks.cu"
bo_5 = ((blk_sad + ((((macroblocks << 3) + macroblocks) + ((ty * 4) + tx)) * 1096)) + (macroblock_index * 8));
# 56 "src/cuda/largerBlocks.cu"
bo_4 = ((blk_sad + ((((macroblocks << 2) + macroblocks) + ((ty * 2) + tx)) * 1096)) + (macroblock_index * 4));
# 59 "src/cuda/largerBlocks.cu"
}
# 61 "src/cuda/largerBlocks.cu"
for (search_pos = ((int)((threadIdx.x))); (search_pos < 545); search_pos += 32)
# 62 "src/cuda/largerBlocks.cu"
{
# 66 "src/cuda/largerBlocks.cu"
auto uint i00;
# 67 "src/cuda/largerBlocks.cu"
auto uint i01;
# 68 "src/cuda/largerBlocks.cu"
auto uint i10;
# 69 "src/cuda/largerBlocks.cu"
auto uint i11;
# 66 "src/cuda/largerBlocks.cu"
...
# 71 "src/cuda/largerBlocks.cu"
(((uint *)bo_6)[search_pos]) = (i00 + i10);
# 72 "src/cuda/largerBlocks.cu"
(((uint *)bo_6)[search_pos + 548]) = (i01 + i11);
# 73 "src/cuda/largerBlocks.cu"
(((uint *)bo_5)[search_pos]) = (i00 + i01);
# 74 "src/cuda/largerBlocks.cu"
(((uint *)bo_5)[search_pos + 1096]) = (i10 + i11);
# 75 "src/cuda/largerBlocks.cu"
(((uint *)bo_4)[search_pos]) = ((i00 + i01) + (i10 + i11));
# 76 "src/cuda/largerBlocks.cu"
}
# 77 "src/cuda/largerBlocks.cu"
}}
# 79 "src/cuda/largerBlocks.cu"
__attribute__((__global__)) void _Z18larger_sad_calc_16Ptii(
# 79 "src/cuda/largerBlocks.cu"
unsigned short *blk_sad,
# 80 "src/cuda/largerBlocks.cu"
int mb_width,
# 81 "src/cuda/largerBlocks.cu"
int mb_height){
# 82 "src/cuda/largerBlocks.cu"
{
# 84 "src/cuda/largerBlocks.cu"
auto int mb_x;
# 85 "src/cuda/largerBlocks.cu"
auto int mb_y;
# 88 "src/cuda/largerBlocks.cu"
auto int macroblocks;
# 89 "src/cuda/largerBlocks.cu"
auto int macroblock_index;
# 91 "src/cuda/largerBlocks.cu"
auto int search_pos;
# 93 "src/cuda/largerBlocks.cu"
auto unsigned short *bi;
# 94 "src/cuda/largerBlocks.cu"
...
# 89 "src/cuda/largerBlocks.cu"
macroblock_index = (((__mul24(mb_y, mb_width)) + mb_x) * 1096);
# 97 "src/cuda/largerBlocks.cu"
bi = ((blk_sad + ((macroblocks + macroblock_index) << 2)) + macroblocks);
# 101 "src/cuda/largerBlocks.cu"
bo_3 = ((blk_sad + ((macroblocks + macroblock_index) << 1)) + macroblocks);
# 104 "src/cuda/largerBlocks.cu"
bo_2 = ((blk_sad + macroblocks) + (macroblock_index * 2));
# 107 "src/cuda/largerBlocks.cu"
bo_1 = (blk_sad + macroblock_index);
# 109 "src/cuda/largerBlocks.cu"
for (search_pos = ((int)((threadIdx.x))); (search_pos < 545); search_pos += 32)
# 110 "src/cuda/largerBlocks.cu"
{
# 114 "src/cuda/largerBlocks.cu"
auto uint i00;
# 115 "src/cuda/largerBlocks.cu"
auto uint i01;
# 116 "src/cuda/largerBlocks.cu"
auto uint i10;
# 117 "src/cuda/largerBlocks.cu"
auto uint i11;
# 114 "src/cuda/largerBlocks.cu"
i00 = (((uint *)bi)[search_pos]);
# 115 "src/cuda/largerBlocks.cu"
...
# 119 "src/cuda/largerBlocks.cu"
(((uint *)bo_3)[search_pos]) = (i00 + i10);
# 120 "src/cuda/largerBlocks.cu"
(((uint *)bo_3)[search_pos + 548]) = (i01 + i11);
# 121 "src/cuda/largerBlocks.cu"
(((uint *)bo_2)[search_pos]) = (i00 + i01);
# 122 "src/cuda/largerBlocks.cu"
(((uint *)bo_2)[search_pos + 548]) = (i10 + i11);
# 123 "src/cuda/largerBlocks.cu"
(((uint *)bo_1)[search_pos]) = ((i00 + i01) + (i10 + i11));
# 124 "src/cuda/largerBlocks.cu"
}
# 125 "src/cuda/largerBlocks.cu"
}}
