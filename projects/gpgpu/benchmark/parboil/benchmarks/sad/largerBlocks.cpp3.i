...
__attribute__((__global__)) __attribute__((__used__)) extern void _Z17larger_sad_calc_8Ptii(unsigned short *const, const int, const int);
# 79 "src/cuda/largerBlocks.cu"
__attribute__((__global__)) __attribute__((__used__)) extern void _Z18larger_sad_calc_16Ptii(unsigned short *const, const int, const int);
...
# 19 "src/cuda/largerBlocks.cu"
__attribute__((__global__)) __attribute__((__used__)) void _Z17larger_sad_calc_8Ptii(
# 19 "src/cuda/largerBlocks.cu"
__attribute__((__shared__)) unsigned short *const blk_sad,
# 20 "src/cuda/largerBlocks.cu"
__attribute__((__shared__)) const int mb_width,
# 21 "src/cuda/largerBlocks.cu"
__attribute__((__shared__)) const int mb_height){
# 21 "src/cuda/largerBlocks.cu"
{
...
# 79 "src/cuda/largerBlocks.cu"
__attribute__((__global__)) __attribute__((__used__)) void _Z18larger_sad_calc_16Ptii(
# 79 "src/cuda/largerBlocks.cu"
__attribute__((__shared__)) unsigned short *const blk_sad,
