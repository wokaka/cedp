...
public interface Annotatable
{
	...
	/**
	 * Returns the string representation of the annotations with the given
	 * relative position.
	 */
	String annotationToString(int position);

	/**
	 * Returns the string representation of the object with annotations being
	 * printed as well.
	 */
