...
public class Inline
{
  ...
  protected void inlineCall(FunctionCall call)
  {
    ...
    for (int i = 0; i < n; ++i)
    {
      ...
      Identifier parami = (Identifier)((VariableDeclaration)params.get(i)).getDeclaredSymbols().get(0);
        ...
        || call.getParent() instanceof UnaryExpression)
    {
      ...
      try { 
        func_stmt = iter.next(ReturnStatement.class);
      } catch (NoSuchElementException e) {
    ...
    for (;;)
    {
      ...
      try {
        ret = inline_iter.next(ReturnStatement.class);
      } catch (NoSuchElementException e) {
        break;
      }
  ...
  public void start()
  {
    ...
    for (;;)
    {
      ...
      try {
        call = iter.next(FunctionCall.class);
      } catch (NoSuchElementException e) {
        break;
      }
