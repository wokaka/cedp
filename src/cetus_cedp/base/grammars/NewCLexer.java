...
public NewCLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("return", this), new Integer(60));
	literals.put(new ANTLRHashString("_Bool", this), new Integer(35));
	literals.put(new ANTLRHashString("__builtin_va_arg", this), new Integer(101));
	literals.put(new ANTLRHashString("sizeof", this), new Integer(99));
	literals.put(new ANTLRHashString("__builtin_offsetof", this), new Integer(102));
	...
	literals.put(new ANTLRHashString("do", this), new Integer(55));
	...
	literals.put(new ANTLRHashString("__asm", this), new Integer(48));
	...
	literals.put(new ANTLRHashString("__alignof__", this), new Integer(100));
	literals.put(new ANTLRHashString("auto", this), new Integer(15));
	literals.put(new ANTLRHashString("enum", this), new Integer(14));
	literals.put(new ANTLRHashString("goto", this), new Integer(57));
	...
	literals.put(new ANTLRHashString("__label__", this), new Integer(53));
	...
	literals.put(new ANTLRHashString("continue", this), new Integer(58));
	...
	literals.put(new ANTLRHashString("switch", this), new Integer(65));
	...
	literals.put(new ANTLRHashString("break", this), new Integer(59));
	literals.put(new ANTLRHashString("while", this), new Integer(54));
