...
void ComputeX(uint4* d_Work, float* d_Output, int Offset, struct _gpufi_data_ *gpufi_dev)
{
  ...
  GPUFI_KERNEL_KERNEL(gpufi_dev, 0);
  
	GPUFI_KERNEL_VARIABLE(gpufi_dev, 100, "thid", (int *)&thid);
  ...
  //GPUFI_KERNEL_VARIABLE(gpufi_dev, 0, "blockDim.x", (int *)&blockDim.x);
	GPUFI_KERNEL_VARIABLE(gpufi_dev, 0, "blockDim.x", (int *)&blockDim_x_temp);
  ...
  for(unsigned int s = blockDim_x_temp>>1; s > 0;  s = s>>1)
    {
      ...
      GPUFI_KERNEL_VARIABLE(gpufi_dev, 0, "blockDim.x", (int *)&blockDim.x);
      GPUFI_KERNEL_VARIABLE(gpufi_dev, 1, "s", (int *)&s);
      GPUFI_KERNEL_VARIABLE(gpufi_dev, 2, "thid", (int *)&thid);
      if (thid < s)
        Data[thid] += Data[thid+s];
      GPUFI_KERNEL_VARIABLE(gpufi_dev, 3, "Data[thid]", (int *)&Data[thid]);
      GPUFI_KERNEL_VARIABLE(gpufi_dev, 4, "Offset", (int *)&Offset);
      GPUFI_KERNEL_VARIABLE(gpufi_dev, 5, "blid", (int *)&blid);
      GPUFI_KERNEL_VARIABLE(gpufi_dev, 6, "blid", (int *)&d_Work);
      GPUFI_KERNEL_VARIABLE(gpufi_dev, 7, "blid", (int *)&d_Output);
      GPUFI_KERNEL_VARIABLE_STREAM(gpufi_dev, 8, "data", (int *)d_Work, 3510150, 1);
      GPUFI_KERNEL_VARIABLE_STREAM(gpufi_dev, 9, "data", (int *)d_Work, 3510150, 10);
      GPUFI_KERNEL_VARIABLE_STREAM(gpufi_dev, 10, "data", (int *)d_Work, 3510150, 100);
      GPUFI_KERNEL_VARIABLE_STREAM(gpufi_dev, 11, "data", (int *)d_Work, 3510150, 1000);
      GPUFI_KERNEL_VARIABLE_STREAM(gpufi_dev, 12, "data", (int *)&d_Work, 3510150, 10000);
/*      GPUFI_KERNEL_VARIABLE_STREAM(gpufi_dev, 13, "data", (int *)d_Output, 3510150, 1);
      GPUFI_KERNEL_VARIABLE_STREAM(gpufi_dev, 14, "data", (int *)d_Output, 3510150, 10);
      GPUFI_KERNEL_VARIABLE_STREAM(gpufi_dev, 15, "data", (int *)d_Output, 3510150, 100);
      GPUFI_KERNEL_VARIABLE_STREAM(gpufi_dev, 16, "data", (int *)d_Output, 3510150, 1000);
      GPUFI_KERNEL_VARIABLE_STREAM(gpufi_dev, 17, "data", (int *)d_Output, 3510150, 10000);*/
      GPUFI_KERNEL_VARIABLE_STREAM(gpufi_dev, 13, "data", (int *)Data, BLOCK_SIZE, 1);
      GPUFI_KERNEL_VARIABLE_STREAM(gpufi_dev, 14, "data", (int *)Data, BLOCK_SIZE, 10);
      GPUFI_KERNEL_VARIABLE_STREAM(gpufi_dev, 15, "data", (int *)Data, BLOCK_SIZE, 100);
      GPUFI_KERNEL_VARIABLE_STREAM(gpufi_dev, 16, "data", (int *)Data, BLOCK_SIZE, 1000);
      GPUFI_KERNEL_VARIABLE_STREAM(gpufi_dev, 17, "data", (int *)Data, BLOCK_SIZE, 10000);
			    ...
			    uint2* d_FinalReduce, int block_size, int Offset, struct _gpufi_data_ *gpufi_dev)
{
  ...
  __shared__ float Result1[BLOCK_SIZE];
...
retry:
  ...
  if(thid < offset){
    ...
    Result1[thid] = d_Output[firstElement + thid];
  }
  else{
    Result[thid] = 0.0f;
    Result1[thid] = 0.0f;
