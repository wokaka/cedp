...
static void _Z10RandomInitj(uint32);
# 71 "src/cuda_fi_prerun/rand_gen.cu"
static void _Z7BRandomv(void);
# 19 "src/cuda_fi_prerun/petri_kernel.cu"
static void _Z15fire_transitionPcPiiiiii(char *, int *, int, int, int, int, int);
# 74 "src/cuda_fi_prerun/petri_kernel.cu"
static void _Z15initialize_gridPiii(int *, int, int);
# 91 "src/cuda_fi_prerun/petri_kernel.cu"
static void _Z14run_trajectoryPiii(int *, int, int);
# 124 "src/cuda_fi_prerun/petri_kernel.cu"
static void _Z19compute_reward_statPiPfS_i(int *, float *, int *, int);
# 202 "src/cuda_fi_prerun/petri_kernel.cu"
__attribute__((__global__)) __attribute__((__used__)) extern void _Z14PetrinetKernelPiPfS_iiiP12_gpufi_data_(int *const, float *const, int *const, const int, const int, const int, struct _gpufi_data_ *const);
...
static __attribute__((__used__)) __attribute__((__shared__)) uint32 mt [624];
...
# 40 "src/cuda_fi_prerun/randomc.h" 2
# 101 "/usr/local/cuda/bin/../include/sm_11_atomic_functions.h"
...
y = (((mt[((threadIdx.x))]) & 2147483648U) | ((mt[(((threadIdx.x)) + 1U)]) & 2147483647U));
# 84 "src/cuda_fi_prerun/rand_gen.cu"
y = (((mt[(((threadIdx.x)) + 397U)]) ^ (y >> 1)) ^ ((y & 1U) ? 2567483615U : 0U));
...
y = (((mt[(((threadIdx.x)) + 227U)]) ^ (y >> 1)) ^ ((y & 1U) ? 2567483615U : 0U));
...
(mt[623]) = (((mt[396]) ^ (y >> 1)) ^ ((y & 1U) ? 2567483615U : 0U));
...
# 19 "src/cuda_fi_prerun/petri_kernel.cu"
static void _Z15fire_transitionPcPiiiiii(
# 19 "src/cuda_fi_prerun/petri_kernel.cu"
char *g_places,
# 19 "src/cuda_fi_prerun/petri_kernel.cu"
int *conflict_array,
...
if (((threadIdx.x)) < ((unsigned)thd_thrd))
...
# 74 "src/cuda_fi_prerun/petri_kernel.cu"
static void _Z15initialize_gridPiii(
# 74 "src/cuda_fi_prerun/petri_kernel.cu"
int *g_places,
# 74 "src/cuda_fi_prerun/petri_kernel.cu"
int NSQUARE2,
...
val = ((int)((mt[((threadIdx.x))]) % ((unsigned)NSQUARE2)));
...
val = ((int)((mt[(((threadIdx.x)) + 256U)]) % ((unsigned)NSQUARE2)));
...
val = ((int)((mt[(((threadIdx.x)) + 512U)]) % ((unsigned)NSQUARE2)));
...
# 124 "src/cuda_fi_prerun/petri_kernel.cu"
static void _Z19compute_reward_statPiPfS_i(
# 124 "src/cuda_fi_prerun/petri_kernel.cu"
int *g_places,
# 124 "src/cuda_fi_prerun/petri_kernel.cu"
float *g_vars,
...
data = (g_places[(((threadIdx.x)) + ((unsigned)(i << 8)))]);
...
(((float *)mt)[(threadIdx.x)]) = sum;
# 171 "src/cuda_fi_prerun/petri_kernel.cu"
(mt[((threadIdx.x)) + 256U]) = ((uint32)max);
...
(g_vars[(blockIdx.x)]) = ((fdividef((((float *)mt)[0]), ((float)NSQUARE2))) - (1.0F));
# 190 "src/cuda_fi_prerun/petri_kernel.cu"
(g_maxs[(blockIdx.x)]) = ((int)(mt[256]));
# 191 "src/cuda_fi_prerun/petri_kernel.cu"
}
# 192 "src/cuda_fi_prerun/petri_kernel.cu"
}
# 202 "src/cuda_fi_prerun/petri_kernel.cu"
__attribute__((__global__)) __attribute__((__used__)) void _Z14PetrinetKernelPiPfS_iiiP12_gpufi_data_(
# 202 "src/cuda_fi_prerun/petri_kernel.cu"
__attribute__((__shared__)) int *const __val_paramg_s,
# 202 "src/cuda_fi_prerun/petri_kernel.cu"
__attribute__((__shared__)) float *const __val_paramg_v,
# 202 "src/cuda_fi_prerun/petri_kernel.cu"
__attribute__((__shared__)) int *const __val_paramg_m,
# 202 "src/cuda_fi_prerun/petri_kernel.cu"
__attribute__((__shared__)) const int __val_paramn,
# 202 "src/cuda_fi_prerun/petri_kernel.cu"
__attribute__((__shared__)) const int __val_params,
# 202 "src/cuda_fi_prerun/petri_kernel.cu"
__attribute__((__shared__)) const int __val_paramseed,
# 202 "src/cuda_fi_prerun/petri_kernel.cu"
__attribute__((__shared__)) struct _gpufi_data_ *const gpufi_dev){int *g_s = __val_paramg_s;float *g_v = __val_paramg_v;int *g_m = __val_paramg_m;int n = __val_paramn;int s = __val_params;int seed = __val_paramseed;
# 202 "src/cuda_fi_prerun/petri_kernel.cu"
{
...
# 231 "src/cuda_fi_prerun/petri_kernel.cu"
g_places = (g_s + (((blockIdx.x)) * ((unsigned)((NSQUARE2 >> 2) + NSQUARE2))));
