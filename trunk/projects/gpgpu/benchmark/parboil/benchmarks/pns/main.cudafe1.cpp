...
# 203
{ 
GPUFI_KERNEL(gpufi_dev, 0, 0, (char *)("PetrinetKernel")); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 0, (char *)("g_s"), (int *)(&g_s), 3); 


GPUFI_KERNEL_VARIABLE(gpufi_dev, 1, (char *)("g_v"), (int *)(&g_v), 4); 


GPUFI_KERNEL_VARIABLE(gpufi_dev, 2, (char *)("g_m"), (int *)(&g_m), 3); 


GPUFI_KERNEL_VARIABLE(gpufi_dev, 3, (char *)("n"), (int *)(&n), 1); 


GPUFI_KERNEL_VARIABLE(gpufi_dev, 4, (char *)("s"), (int *)(&s), 1); 


GPUFI_KERNEL_VARIABLE(gpufi_dev, 5, (char *)("seed"), (int *)(&seed), 1); 
# 227 "src/cuda_fi_prerun/petri_kernel.cu"
auto int NSQUARE2 = ((n * n) * 2); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 6, (char *)("NSQUARE2"), (int *)(&NSQUARE2), 1); 


auto int *g_places = (g_s + blockIdx.x * ((NSQUARE2 >> 2) + NSQUARE2)); 
GPUFI_KERNEL_VARIABLE(gpufi_dev, 7, (char *)("g_places"), (int *)(&g_places), 3); 
...
GPUFI_KERNEL(gpufi_dev, 1, 0, (char *)("PetrinetKernel")); 
} 
#endif
...
cudaConfigureCall(grid, threads) ? ((void)0) : (PetrinetKernel__entry)(g_places, g_vars, g_maxs, N, s, 5489 * (i + 1), __shadow_var(,gpufi_dev)); 
...
cudaConfigureCall(grid1, threads) ? ((void)0) : (PetrinetKernel__entry)(g_places, g_vars, g_maxs, N, s, time(__null), __shadow_var(,gpufi_dev)); 
