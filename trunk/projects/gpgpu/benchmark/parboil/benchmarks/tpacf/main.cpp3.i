...
__attribute__((__global__)) __attribute__((__used__)) extern void _Z9gen_histsPmPfS0_S0_ii(hist_t *const, float *const, float *const, float *const, const int, const int);
...
# 50 "src/cuda/scan_largearray_kernel.cu"
__attribute__((__global__)) __attribute__((__used__)) void _Z9gen_histsPmPfS0_S0_ii(
# 50 "src/cuda/scan_largearray_kernel.cu"
__attribute__((__shared__)) hist_t *const histograms,
# 50 "src/cuda/scan_largearray_kernel.cu"
__attribute__((__shared__)) float *const all_x_data,
# 50 "src/cuda/scan_largearray_kernel.cu"
__attribute__((__shared__)) float *const all_y_data,
# 51 "src/cuda/scan_largearray_kernel.cu"
__attribute__((__shared__)) float *const all_z_data,
# 51 "src/cuda/scan_largearray_kernel.cu"
__attribute__((__shared__)) const int NUM_SETS,
# 51 "src/cuda/scan_largearray_kernel.cu"
__attribute__((__shared__)) const int NUM_ELEMENTS){
# 51 "src/cuda/scan_largearray_kernel.cu"
{
