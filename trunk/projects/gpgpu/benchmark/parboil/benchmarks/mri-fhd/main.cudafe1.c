...
float RhoPhiI;};
# 38 "/usr/include/bits/mathinline.h" 3
union __C9 { float __f; int __i;};





union __C10 { double __d; int __i[2];};
...
extern  __attribute__((__extern_weak__ __weak__))  /* COMDAT group: __signbitf */ __inline__ int __signbitf(float) __attribute__((__const__));





extern  __attribute__((__extern_weak__ __weak__))  /* COMDAT group: __signbit */ __inline__ int __signbit(double) __attribute__((__const__));





extern  __attribute__((__extern_weak__ __weak__)) __inline__ int __signbitl(long double) __attribute__((__const__));
# 184 "/usr/include/stdlib.h" 3
extern long strtol(const char *__restrict__, char **__restrict__, int);
# 473 "/usr/include/stdlib.h" 3
extern void *calloc(size_t, size_t) __attribute__((__malloc__));
...
# 118 "/afs/crhc.illinois.edu/project/depend/yim6/clairvoyant/fi/cedp/cedp/projects/gpgpu/benchmark/parboil/common/include/parboil.h"
...
extern void pb_SwitchToTimer(struct pb_TimerSet *, enum pb_TimerID);



extern void pb_PrintTimerSet(struct pb_TimerSet *);
# 9 "src/cuda_wo_loop/file.h"
extern void _Z9inputDataPcPiS0_PPfS2_S2_S2_S2_S2_S2_S2_S2_S2_(char *, int *, int *, float **, float **, float **, float **, float **, float **, float **, float **, float **, float **);





extern void _Z10outputDataPcPfS0_i(char *, float *, float *, int);
# 38 "src/cuda_wo_loop/computeFH.cu"
extern void _Z17createDataStructsiiRPfS0_S0_S0_(int, int, float **, float **, float **, float **);
# 145 "src/cuda_wo_loop/computeFH.cu"
extern void _Z17computeRhoPhi_GPUiPfS_S_S_S_S_(int, float *, float *, float *, float *, float *, float *);
# 163 "src/cuda_wo_loop/computeFH.cu"
extern void _Z13computeFH_GPUiiPfS_S_P7kValuesS_S_(int, int, float *, float *, float *, struct kValues *, float *, float *);
# 184 "/usr/local/cuda/bin/../include/cuda_runtime.h"
extern  __attribute__((__weak__)) /* COMDAT group: _Z18cudaMemcpyToSymbolIA512_7kValuesE9cudaErrorRKT_PKvjj14cudaMemcpyKind */ __inline__ cudaError_t _Z18cudaMemcpyToSymbolIA512_7kValuesE9cudaErrorRKT_PKvjj14cudaMemcpyKind(const struct kValues (*)[512], const void *, size_t, size_t, enum cudaMemcpyKind);
# 38 "src/cuda_wo_loop/main.cu"
static void _Z14setupMemoryGPUiiRPfS0_(int, int, float **, float **);
# 47 "src/cuda_wo_loop/main.cu"
static void _Z16cleanupMemoryGPUiiRPfS_(int, int, float **, float *);
# 56 "src/cuda_wo_loop/main.cu"
extern int main(int, char **);
static void __sti___12_main_cpp1_ii_d1c9fc4c(void) __attribute__((__constructor__));
...
# 38 "/usr/include/bits/mathinline.h" 3
(__u.__f) = __x; {
__T22 = ((int)(((__u.__i)) < 0)); return __T22; }
}

extern  __attribute__((__extern_weak__ __weak__))  /* COMDAT group: __signbit */ __inline__ int __signbit( double __x)
{ auto int __T23;
auto union __C10 __u;
# 44 "/usr/include/bits/mathinline.h" 3
(__u.__d) = __x; {
__T23 = ((int)((((int *)(&__u.__i))[1]) < 0)); return __T23; }
}
# 38 "src/cuda_wo_loop/computeFH.cu"
void _Z17createDataStructsiiRPfS0_S0_S0_( int numK,  int numX, 
float **realRhoPhi,  float **imagRhoPhi, 
float **outR,  float **outI)
{
(*realRhoPhi) = ((float *)(calloc(((size_t)numK), 4U)));
(*imagRhoPhi) = ((float *)(calloc(((size_t)numK), 4U)));
(*outR) = ((float *)(calloc(((size_t)numX), 4U)));
(*outI) = ((float *)(calloc(((size_t)numX), 4U))); 
}
# 145 "src/cuda_wo_loop/computeFH.cu"
void _Z17computeRhoPhi_GPUiPfS_S_S_S_S_( int numK, 
float *phiR_d,  float *phiI_d,  float *dR_d,  float *dI_d, 
float *realRhoPhi_d,  float *imagRhoPhi_d)
{ auto unsigned __T26;
auto int rhoPhiBlocks;
...
# 149 "src/cuda_wo_loop/computeFH.cu"
rhoPhiBlocks = (numK / 512);

if (numK % 512) {
rhoPhiBlocks++; }

{ (DimRhoPhiBlock.x) = 512U; (DimRhoPhiBlock.y) = 1U; (DimRhoPhiBlock.z) = 1U; }
{ __T26 = ((unsigned)rhoPhiBlocks); { (DimRhoPhiGrid.x) = __T26; (DimRhoPhiGrid.y) = 1U; (DimRhoPhiGrid.z) = 1U; } }



((int)(cudaConfigureCall(DimRhoPhiGrid, DimRhoPhiBlock, 0U, 0))) ? ((void)0) : (__device_stub__Z16ComputeRhoPhiGPUiPfS_S_S_S_S_(numK, phiR_d, phiI_d, dR_d, dI_d, realRhoPhi_d, imagRhoPhi_d)); 

}

void _Z13computeFH_GPUiiPfS_S_P7kValuesS_S_( int numK,  int numX, 
...
auto dim3 DimFHGrid;
# 168 "src/cuda_wo_loop/computeFH.cu"
FHGrids = (numK / 512);
if (numK % 512) {
FHGrids++; }
FHBlocks = (numX / 256);
if (numX % 256) {
FHBlocks++; }
{ (DimFHBlock.x) = 256U; (DimFHBlock.y) = 1U; (DimFHBlock.z) = 1U; }
{ __T27 = ((unsigned)FHBlocks); { (DimFHGrid.x) = __T27; (DimFHGrid.y) = 1U; (DimFHGrid.z) = 1U; } } {




auto int FHGrid;
# 180 "src/cuda_wo_loop/computeFH.cu"
FHGrid = 0; for (; (FHGrid < FHGrids); FHGrid++) {

auto int FHGridBase;

auto struct kValues *kValsTile;
auto int numElems;
# 182 "src/cuda_wo_loop/computeFH.cu"
FHGridBase = (FHGrid * 512);

kValsTile = (kVals + FHGridBase);
numElems = ((512 < (numK - FHGridBase)) ? 512 : (numK - FHGridBase));
_Z18cudaMemcpyToSymbolIA512_7kValuesE9cudaErrorRKT_PKvjj14cudaMemcpyKind(((const struct kValues (*)[512])__shadow_var(c,c)), ((const void *)kValsTile), (((unsigned)numElems) * 20U), 0U, cudaMemcpyHostToDevice);
{ auto cudaError_t err;
# 187 "src/cuda_wo_loop/computeFH.cu"
if ((int)(err = (cudaGetLastError()))) { fprintf(stderr, "CUDA error on line %d: %s\n", 187, (cudaGetErrorString(err))); exit((-1)); } }

((int)(cudaConfigureCall(DimFHGrid, DimFHBlock, 0U, 0))) ? ((void)0) : (__device_stub__Z13ComputeFH_GPUiiPfS_S_S_S_(numK, FHGridBase, x_d, y_d, z_d, outR_d, outI_d));

{ auto cudaError_t err;
# 191 "src/cuda_wo_loop/computeFH.cu"
if ((int)(err = (cudaGetLastError()))) { fprintf(stderr, "CUDA error on line %d: %s\n", 191, (cudaGetErrorString(err))); exit((-1)); } }
} } 
}
# 184 "/usr/local/cuda/bin/../include/cuda_runtime.h"
 __attribute__((__weak__)) /* COMDAT group: _Z18cudaMemcpyToSymbolIA512_7kValuesE9cudaErrorRKT_PKvjj14cudaMemcpyKind */ __inline__ cudaError_t _Z18cudaMemcpyToSymbolIA512_7kValuesE9cudaErrorRKT_PKvjj14cudaMemcpyKind(
const struct kValues (*symbol)[512], 
const void *src, 
size_t count, 
size_t offset, 
...
# 38 "src/cuda_wo_loop/main.cu"
static void _Z14setupMemoryGPUiiRPfS0_( int num,  int size,  float **dev_ptr,  float **host_ptr)
{
cudaMalloc(((void **)dev_ptr), ((size_t)(num * size)));
{ auto cudaError_t err;
# 41 "src/cuda_wo_loop/main.cu"
if ((int)(err = (cudaGetLastError()))) { fprintf(stderr, "CUDA error on line %d: %s\n", 41, (cudaGetErrorString(err))); exit((-1)); } }
cudaMemcpy(((void *)((*dev_ptr))), ((const void *)((*host_ptr))), ((size_t)(num * size)), cudaMemcpyHostToDevice);
{ auto cudaError_t err;
...
static void _Z16cleanupMemoryGPUiiRPfS_( int num,  int size,  float **dev_ptr,  float *host_ptr)
{
cudaMemcpy(((void *)host_ptr), ((const void *)((*dev_ptr))), ((size_t)(num * size)), cudaMemcpyDeviceToHost);
{ auto cudaError_t err;
# 50 "src/cuda_wo_loop/main.cu"
if ((int)(err = (cudaGetLastError()))) { fprintf(stderr, "CUDA error on line %d: %s\n", 50, (cudaGetErrorString(err))); exit((-1)); } }
cudaFree(((void *)((*dev_ptr))));
{ auto cudaError_t err;
# 52 "src/cuda_wo_loop/main.cu"
...
auto float *dI;
auto float *realRhoPhi;
# 64 "src/cuda_wo_loop/main.cu"
auto float *imagRhoPhi;
auto float *outI;
# 65 "src/cuda_wo_loop/main.cu"
auto float *outR;
auto struct kValues *kVals;



auto struct pb_Parameters *params;
...
if (((((params->inpFiles))[0]) == ((char *)0)) || ((((params->inpFiles))[1]) != ((char *)0)))
{
...
_Z9inputDataPcPiS0_PPfS2_S2_S2_S2_S2_S2_S2_S2_S2_((((params->inpFiles))[0]), (&original_numK), (&numX), (&kx), (&ky), (&kz), (&x), (&y), (&z), (&phiR), (&phiI), (&dR), (&dI));
...
auto int inputK;
auto char *end;
inputK = ((int)(strtol(((const char *)(argv[1])), (&end), 10)));
if (end == (argv[1]))
{
...
_Z17createDataStructsiiRPfS0_S0_S0_(numK, numX, (&realRhoPhi), (&imagRhoPhi), (&outR), (&outI));
kVals = ((struct kValues *)(calloc(((size_t)numK), 20U)));
...
auto float *dI_d;
auto float *realRhoPhi_d;
# 124 "src/cuda_wo_loop/main.cu"
auto float *imagRhoPhi_d;

pb_SwitchToTimer((&timers), pb_TimerID_COPY);
_Z14setupMemoryGPUiiRPfS0_(numK, 4, (&phiR_d), (&phiR));
_Z14setupMemoryGPUiiRPfS0_(numK, 4, (&phiI_d), (&phiI));
_Z14setupMemoryGPUiiRPfS0_(numK, 4, (&dR_d), (&dR));
_Z14setupMemoryGPUiiRPfS0_(numK, 4, (&dI_d), (&dI));
cudaMalloc(((void **)(&realRhoPhi_d)), (((unsigned)numK) * 4U));
{ auto cudaError_t err;
# 132 "src/cuda_wo_loop/main.cu"
if ((int)(err = (cudaGetLastError()))) { fprintf(stderr, "CUDA error on line %d: %s\n", 132, (cudaGetErrorString(err))); exit((-1)); } }
cudaMalloc(((void **)(&imagRhoPhi_d)), (((unsigned)numK) * 4U));
{ auto cudaError_t err;
# 134 "src/cuda_wo_loop/main.cu"
...
_Z17computeRhoPhi_GPUiPfS_S_S_S_S_(numK, phiR_d, phiI_d, dR_d, dI_d, realRhoPhi_d, imagRhoPhi_d);


if ((params->synchronizeGpu)) { cudaThreadSynchronize(); }
pb_SwitchToTimer((&timers), pb_TimerID_COPY);

_Z16cleanupMemoryGPUiiRPfS_(numK, 4, (&realRhoPhi_d), realRhoPhi);
_Z16cleanupMemoryGPUiiRPfS_(numK, 4, (&imagRhoPhi_d), imagRhoPhi);
cudaFree(((void *)phiR_d));
cudaFree(((void *)phiI_d));
cudaFree(((void *)dR_d));
cudaFree(((void *)dI_d));
}
...
_Z14setupMemoryGPUiiRPfS0_(numX, 4, (&x_d), (&x));
_Z14setupMemoryGPUiiRPfS0_(numX, 4, (&y_d), (&y));
_Z14setupMemoryGPUiiRPfS0_(numX, 4, (&z_d), (&z));



cudaMalloc(((void **)(&outR_d)), (((unsigned)numX) * 4U));
{ auto cudaError_t err;
# 180 "src/cuda_wo_loop/main.cu"
if ((int)(err = (cudaGetLastError()))) { fprintf(stderr, "CUDA error on line %d: %s\n", 180, (cudaGetErrorString(err))); exit((-1)); } }
cudaMemset(((void *)outR_d), 0, (((unsigned)numX) * 4U));
{ auto cudaError_t err;
# 182 "src/cuda_wo_loop/main.cu"
if ((int)(err = (cudaGetLastError()))) { fprintf(stderr, "CUDA error on line %d: %s\n", 182, (cudaGetErrorString(err))); exit((-1)); } }
cudaMalloc(((void **)(&outI_d)), (((unsigned)numX) * 4U));
{ auto cudaError_t err;
# 184 "src/cuda_wo_loop/main.cu"
if ((int)(err = (cudaGetLastError()))) { fprintf(stderr, "CUDA error on line %d: %s\n", 184, (cudaGetErrorString(err))); exit((-1)); } }
cudaMemset(((void *)outI_d), 0, (((unsigned)numX) * 4U));
{ auto cudaError_t err;
...
_Z13computeFH_GPUiiPfS_S_P7kValuesS_S_(numK, numX, x_d, y_d, z_d, kVals, outR_d, outI_d);

if ((params->synchronizeGpu)) { cudaThreadSynchronize(); }
pb_SwitchToTimer((&timers), pb_TimerID_COPY);


_Z16cleanupMemoryGPUiiRPfS_(numX, 4, (&outR_d), outR);
_Z16cleanupMemoryGPUiiRPfS_(numX, 4, (&outI_d), outI);
...
if (((params->outFile)) != ((char *)0))
{

pb_SwitchToTimer((&timers), pb_TimerID_IO);
_Z10outputDataPcPfS0_i(((params->outFile)), outR, outI, numX);
pb_SwitchToTimer((&timers), pb_TimerID_COMPUTE);
}
...
static void __sti___12_main_cpp1_ii_d1c9fc4c(void) {   }
