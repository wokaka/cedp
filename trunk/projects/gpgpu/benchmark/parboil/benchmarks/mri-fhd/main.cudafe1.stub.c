...
__cudaInitArgBlock(__T24);__cudaSetupArg(__par0, __T24);__cudaSetupArg(__par1, __T24);__cudaSetupArg(__par2, __T24);__cudaSetupArg(__par3, __T24);__cudaSetupArg(__par4, __T24);__cudaSetupArg(__par5, __T24);__cudaSetupArg(__par6, __T24);__cudaSetupArg(__par7, __T24);__cudaLaunch(((char *)__device_stub_name(__device_stub__Z16ComputeRhoPhiGPUiPfS_S_S_S_S_P12_gpufi_data_,((void ( *)(int, float *, float *, float *, float *, float *, float *, struct _gpufi_data_ *))ComputeRhoPhiGPU__entry))));}
#if defined(__cplusplus)
}
...
__cudaInitArgBlock(__T25);__cudaSetupArg(__par0, __T25);__cudaSetupArg(__par1, __T25);__cudaSetupArg(__par2, __T25);__cudaSetupArg(__par3, __T25);__cudaSetupArg(__par4, __T25);__cudaSetupArg(__par5, __T25);__cudaSetupArg(__par6, __T25);__cudaSetupArg(__par7, __T25);__cudaLaunch(((char *)__device_stub_name(__device_stub__Z13ComputeFH_GPUiiPfS_S_S_S_P12_gpufi_data_,((void ( *)(int, int, float *, float *, float *, float *, float *, struct _gpufi_data_ *))ComputeFH_GPU__entry))));}
#if defined(__cplusplus)
}
...
#endif
static void __device_wrapper__Z16ComputeRhoPhiGPUiPfS_S_S_S_S_P12_gpufi_data_(char *__T26){_Z16ComputeRhoPhiGPUiPfS_S_S_S_S_P12_gpufi_data_((((*((struct __T20 *)__T26)).__par0)), (((*((struct __T20 *)__T26)).__par1)), (((*((struct __T20 *)__T26)).__par2)), (((*((struct __T20 *)__T26)).__par3)), (((*((struct __T20 *)__T26)).__par4)), (((*((struct __T20 *)__T26)).__par5)), (((*((struct __T20 *)__T26)).__par6)), (((*((struct __T20 *)__T26)).__par7)));}
#if defined(__cplusplus)
}
#endif
#endif
...
namespace __cuda_emu {
#endif
static void __device_wrapper__Z13ComputeFH_GPUiiPfS_S_S_S_P12_gpufi_data_(char *__T217){_Z13ComputeFH_GPUiiPfS_S_S_S_P12_gpufi_data_((((*((struct __T21 *)__T217)).__par0)), (((*((struct __T21 *)__T217)).__par1)), (((*((struct __T21 *)__T217)).__par2)), (((*((struct __T21 *)__T217)).__par3)), (((*((struct __T21 *)__T217)).__par4)), (((*((struct __T21 *)__T217)).__par5)), (((*((struct __T21 *)__T217)).__par6)), (((*((struct __T21 *)__T217)).__par7)));}
#if defined(__cplusplus)
}
#endif
#endif
