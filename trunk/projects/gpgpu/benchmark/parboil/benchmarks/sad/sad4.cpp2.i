...
/*DEVICE_BUILTIN*/extern __attribute__((__device__)) uint4 __utexfetch(__texture_type__, float4, int);
# 62 "src/cuda/sad4.cu"
__attribute__((__global__)) extern void _Z11mb_sad_calcPtS_ii(unsigned short *, unsigned short *, int, int);
# 40 "src/cuda/sad4.cu"
 __attribute__((__shared__)) unsigned short frame_loc [16];
# 43 "src/cuda/sad4.cu"
 __texture_type__ ref;
# 47 "src/cuda/sad4.cu"
extern __attribute__((__shared__)) unsigned short sad_loc [];
# 48 "src/cuda/sad4.cu"
extern __attribute__((__shared__)) vec8b sad_loc_8b [];
...
# 50 "src/cuda/sad4.cu" 2
# 62 "src/cuda/sad4.cu"
__attribute__((__global__)) void _Z11mb_sad_calcPtS_ii(
# 62 "src/cuda/sad4.cu"
...
# 99 "src/cuda/sad4.cu"
{
# 101 "src/cuda/sad4.cu"
(frame_loc[(((__umul24(((unsigned)ty), 1U)) + ((unsigned)tx)) << 4) + ((unsigned)tgroup)]) = (frame[((cur_o + ((tgroup >> 2) * img_width)) + (tgroup & 3))]);
# 103 "src/cuda/sad4.cu"
}
# 104 "src/cuda/sad4.cu"
}
# 106 "src/cuda/sad4.cu"
__syncthreads();
# 109 "src/cuda/sad4.cu"
if ((mb_x < mb_width) && (mb_y < mb_height))
# 110 "src/cuda/sad4.cu"
{
# 112 "src/cuda/sad4.cu"
auto int frame_x;
# 113 "src/cuda/sad4.cu"
auto int frame_y;
# 116 "src/cuda/sad4.cu"
auto int ref_x;
# 117 "src/cuda/sad4.cu"
auto int ref_y;
# 120 "src/cuda/sad4.cu"
auto int cur_o;
# 122 "src/cuda/sad4.cu"
auto int search_pos;
# 123 "src/cuda/sad4.cu"
auto int search_pos_base;
# 125 "src/cuda/sad4.cu"
auto int search_pos_end;
# 127 "src/cuda/sad4.cu"
auto int sotmp;
# 128 "src/cuda/sad4.cu"
auto int local_search_off_x;
# 129 "src/cuda/sad4.cu"
...
for (; (y < 4); y++)
# 145 "src/cuda/sad4.cu"
{ auto __texture_type__ __T24;
auto float __T25;
auto float __T26;
auto float4 __T27;
auto uint4 __T28;
auto __texture_type__ __T29;
auto float __T210;
auto float __T211;
auto float4 __T212;
auto uint4 __T213;
auto __texture_type__ __T214;
auto float __T215;
auto float __T216;
auto float4 __T217;
auto uint4 __T218;
...
auto float4 __T232;
auto uint4 __T233;
# 146 "src/cuda/sad4.cu"
auto int t;
# 147 "src/cuda/sad4.cu"
t = ((int)((((__T24 = ref) , (__T25 = ((float)search_off_x))) , (__T26 = ((float)(search_off_y + y)))) , ((__T28 = (__utexfetch(__T24, ((((((__T27.x) = __T25) , ((__T27.y) = __T26)) , ((__T27.z) = (0.0F))) , ((__T27.w) = (0.0F))) , __T27), 2))) , ((unsigned short)((__T28.x))))));
# 148 "src/cuda/sad4.cu"
sad1 += (__cuda_abs((t - ((int)(frame_loc[(((cur_o << 4) + (y << 2)) + 0)])))));
# 150 "src/cuda/sad4.cu"
t = ((int)((((__T29 = ref) , (__T210 = ((float)(search_off_x + 1)))) , (__T211 = ((float)(search_off_y + y)))) , ((__T213 = (__utexfetch(__T29, ((((((__T212.x) = __T210) , ((__T212.y) = __T211)) , ((__T212.z) = (0.0F))) , ((__T212.w) = (0.0F))) , __T212), 2))) , ((unsigned short)((__T213.x))))));
# 151 "src/cuda/sad4.cu"
sad1 += (__cuda_abs((t - ((int)(frame_loc[(((cur_o << 4) + (y << 2)) + 1)])))));
# 152 "src/cuda/sad4.cu"
sad2 += (__cuda_abs((t - ((int)(frame_loc[(((cur_o << 4) + (y << 2)) + 0)])))));
# 154 "src/cuda/sad4.cu"
t = ((int)((((__T214 = ref) , (__T215 = ((float)(search_off_x + 2)))) , (__T216 = ((float)(search_off_y + y)))) , ((__T218 = (__utexfetch(__T214, ((((((__T217.x) = __T215) , ((__T217.y) = __T216)) , ((__T217.z) = (0.0F))) , ((__T217.w) = (0.0F))) , __T217), 2))) , ((unsigned short)((__T218.x))))));
# 155 "src/cuda/sad4.cu"
sad1 += (__cuda_abs((t - ((int)(frame_loc[(((cur_o << 4) + (y << 2)) + 2)])))));
# 156 "src/cuda/sad4.cu"
sad2 += (__cuda_abs((t - ((int)(frame_loc[(((cur_o << 4) + (y << 2)) + 1)])))));
# 157 "src/cuda/sad4.cu"
sad3 += (__cuda_abs((t - ((int)(frame_loc[(((cur_o << 4) + (y << 2)) + 0)])))));
# 159 "src/cuda/sad4.cu"
t = ((int)((((__T219 = ref) , (__T220 = ((float)(search_off_x + 3)))) , (__T221 = ((float)(search_off_y + y)))) , ((__T223 = (__utexfetch(__T219, ((((((__T222.x) = __T220) , ((__T222.y) = __T221)) , ((__T222.z) = (0.0F))) , ((__T222.w) = (0.0F))) , __T222), 2))) , ((unsigned short)((__T223.x))))));
# 160 "src/cuda/sad4.cu"
sad1 += (__cuda_abs((t - ((int)(frame_loc[(((cur_o << 4) + (y << 2)) + 3)])))));
# 161 "src/cuda/sad4.cu"
sad2 += (__cuda_abs((t - ((int)(frame_loc[(((cur_o << 4) + (y << 2)) + 2)])))));
# 162 "src/cuda/sad4.cu"
sad3 += (__cuda_abs((t - ((int)(frame_loc[(((cur_o << 4) + (y << 2)) + 1)])))));
# 164 "src/cuda/sad4.cu"
t = ((int)((((__T224 = ref) , (__T225 = ((float)(search_off_x + 4)))) , (__T226 = ((float)(search_off_y + y)))) , ((__T228 = (__utexfetch(__T224, ((((((__T227.x) = __T225) , ((__T227.y) = __T226)) , ((__T227.z) = (0.0F))) , ((__T227.w) = (0.0F))) , __T227), 2))) , ((unsigned short)((__T228.x))))));
# 165 "src/cuda/sad4.cu"
sad2 += (__cuda_abs((t - ((int)(frame_loc[(((cur_o << 4) + (y << 2)) + 3)])))));
# 166 "src/cuda/sad4.cu"
sad3 += (__cuda_abs((t - ((int)(frame_loc[(((cur_o << 4) + (y << 2)) + 2)])))));
# 168 "src/cuda/sad4.cu"
t = ((int)((((__T229 = ref) , (__T230 = ((float)(search_off_x + 5)))) , (__T231 = ((float)(search_off_y + y)))) , ((__T233 = (__utexfetch(__T229, ((((((__T232.x) = __T230) , ((__T232.y) = __T231)) , ((__T232.z) = (0.0F))) , ((__T232.w) = (0.0F))) , __T232), 2))) , ((unsigned short)((__T233.x))))));
# 169 "src/cuda/sad4.cu"
sad3 += (__cuda_abs((t - ((int)(frame_loc[(((cur_o << 4) + (y << 2)) + 3)])))));
# 170 "src/cuda/sad4.cu"
} }
# 173 "src/cuda/sad4.cu"
(sad_loc[(((__umul24(((unsigned)ty), 1U)) + ((unsigned)tx)) * 1096U) + ((unsigned)search_pos)]) = sad1;
# 174 "src/cuda/sad4.cu"
(sad_loc[(((__umul24(((unsigned)ty), 1U)) + ((unsigned)tx)) * 1096U) + ((unsigned)(search_pos + 1))]) = sad2;
# 175 "src/cuda/sad4.cu"
(sad_loc[(((__umul24(((unsigned)ty), 1U)) + ((unsigned)tx)) * 1096U) + ((unsigned)(search_pos + 2))]) = sad3;
# 177 "src/cuda/sad4.cu"
local_search_off_x += 3;
# 178 "src/cuda/sad4.cu"
if (local_search_off_x >= 33)
# 179 "src/cuda/sad4.cu"
{
# 180 "src/cuda/sad4.cu"
local_search_off_x -= 33;
# 181 "src/cuda/sad4.cu"
search_off_y++;
# 182 "src/cuda/sad4.cu"
}
# 183 "src/cuda/sad4.cu"
}
# 184 "src/cuda/sad4.cu"
}
# 186 "src/cuda/sad4.cu"
__syncthreads();
# 190 "src/cuda/sad4.cu"
if ((((threadIdx.x)) >> 5) < 1U)
# 191 "src/cuda/sad4.cu"
{
# 192 "src/cuda/sad4.cu"
auto int tgroup;
# 193 "src/cuda/sad4.cu"
auto int ty;
# 194 "src/cuda/sad4.cu"
auto int tx;
# 195 "src/cuda/sad4.cu"
auto int index;
# 198 "src/cuda/sad4.cu"
auto int mb_x;
# 199 "src/cuda/sad4.cu"
auto int mb_y;
# 200 "src/cuda/sad4.cu"
auto int block_x;
# 201 "src/cuda/sad4.cu"
auto int block_y;
# 192 "src/cuda/sad4.cu"
...
# 201 "src/cuda/sad4.cu"
block_y = ((int)((((unsigned)ty) + (__umul24(((unsigned)by), 1U))) & 3U));
# 203 "src/cuda/sad4.cu"
if ((mb_x < mb_width) && (mb_y < mb_height))
# 204 "src/cuda/sad4.cu"
{
# 207 "src/cuda/sad4.cu"
...
# 213 "src/cuda/sad4.cu"
for (index = tgroup; (index < 274); index += 32) {
# 214 "src/cuda/sad4.cu"
(((vec8b *)blk_sad)[index]) = (sad_loc_8b[((((__umul24(((unsigned)ty), 1U)) + ((unsigned)tx)) * 274U) + ((unsigned)index))]); }
# 216 "src/cuda/sad4.cu"
}
# 217 "src/cuda/sad4.cu"
}
# 218 "src/cuda/sad4.cu"
}}
