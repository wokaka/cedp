...
__global__ void mb_sad_calc(unsigned short * blk_sad, unsigned short * frame, int mb_width, int mb_height,  struct _gpufi_data_ *gpufi_dev)
{
        ...
        for (search_pos=search_pos_base; search_pos<search_pos_end; search_pos+=3)
        {
            ...
            */
            ...
            for (y=0; y<4; y ++ )
            {
                ...
                //GPUFI_KERNEL_VARIABLE(gpufi_dev, 41, "t", (int*)&t, GPUFI_DATATYPE_INTEGER);


                sad1+=abs((t-frame_loc[(((cur_o<<4)+(y<<2))+0)]));
                //GPUFI_KERNEL_VARIABLE(gpufi_dev, 42, "sad1", (int*)&sad1, GPUFI_DATATYPE_UNKNOWN);


                t=tex2D(ref, (search_off_x+1), (search_off_y+y));
                //GPUFI_KERNEL_VARIABLE(gpufi_dev, 43, "t", (int*)&t, GPUFI_DATATYPE_INTEGER);


                sad1+=abs((t-frame_loc[(((cur_o<<4)+(y<<2))+1)]));
                //GPUFI_KERNEL_VARIABLE(gpufi_dev, 44, "sad1", (int*)&sad1, GPUFI_DATATYPE_UNKNOWN);


                sad2+=abs((t-frame_loc[(((cur_o<<4)+(y<<2))+0)]));
                //GPUFI_KERNEL_VARIABLE(gpufi_dev, 45, "sad2", (int*)&sad2, GPUFI_DATATYPE_UNKNOWN);


                t=tex2D(ref, (search_off_x+2), (search_off_y+y));
                //GPUFI_KERNEL_VARIABLE(gpufi_dev, 46, "t", (int*)&t, GPUFI_DATATYPE_INTEGER);


                sad1+=abs((t-frame_loc[(((cur_o<<4)+(y<<2))+2)]));
                //GPUFI_KERNEL_VARIABLE(gpufi_dev, 47, "sad1", (int*)&sad1, GPUFI_DATATYPE_UNKNOWN);


                sad2+=abs((t-frame_loc[(((cur_o<<4)+(y<<2))+1)]));
                //GPUFI_KERNEL_VARIABLE(gpufi_dev, 48, "sad2", (int*)&sad2, GPUFI_DATATYPE_UNKNOWN);


                sad3+=abs((t-frame_loc[(((cur_o<<4)+(y<<2))+0)]));
                //GPUFI_KERNEL_VARIABLE(gpufi_dev, 49, "sad3", (int*)&sad3, GPUFI_DATATYPE_UNKNOWN);


                t=tex2D(ref, (search_off_x+3), (search_off_y+y));
                //GPUFI_KERNEL_VARIABLE(gpufi_dev, 50, "t", (int*)&t, GPUFI_DATATYPE_INTEGER);


                sad1+=abs((t-frame_loc[(((cur_o<<4)+(y<<2))+3)]));
                //GPUFI_KERNEL_VARIABLE(gpufi_dev, 51, "sad1", (int*)&sad1, GPUFI_DATATYPE_UNKNOWN);


                sad2+=abs((t-frame_loc[(((cur_o<<4)+(y<<2))+2)]));
                //GPUFI_KERNEL_VARIABLE(gpufi_dev, 52, "sad2", (int*)&sad2, GPUFI_DATATYPE_UNKNOWN);


                sad3+=abs((t-frame_loc[(((cur_o<<4)+(y<<2))+1)]));
                //GPUFI_KERNEL_VARIABLE(gpufi_dev, 53, "sad3", (int*)&sad3, GPUFI_DATATYPE_UNKNOWN);


                t=tex2D(ref, (search_off_x+4), (search_off_y+y));
                //GPUFI_KERNEL_VARIABLE(gpufi_dev, 54, "t", (int*)&t, GPUFI_DATATYPE_INTEGER);


                sad2+=abs((t-frame_loc[(((cur_o<<4)+(y<<2))+3)]));
                //GPUFI_KERNEL_VARIABLE(gpufi_dev, 55, "sad2", (int*)&sad2, GPUFI_DATATYPE_UNKNOWN);


                sad3+=abs((t-frame_loc[(((cur_o<<4)+(y<<2))+2)]));
                //GPUFI_KERNEL_VARIABLE(gpufi_dev, 56, "sad3", (int*)&sad3, GPUFI_DATATYPE_UNKNOWN);


                t=tex2D(ref, (search_off_x+5), (search_off_y+y));
                //GPUFI_KERNEL_VARIABLE(gpufi_dev, 57, "t", (int*)&t, GPUFI_DATATYPE_INTEGER);


                sad3+=abs((t-frame_loc[(((cur_o<<4)+(y<<2))+3)]));
                //GPUFI_KERNEL_VARIABLE(gpufi_dev, 58, "sad3", (int*)&sad3, GPUFI_DATATYPE_UNKNOWN);
            ...
            //GPUFI_KERNEL_VARIABLE(gpufi_dev, 59, "sad_loc[(((__umul24(ty, 1)+tx)*1096)+search_pos)]", (int*)&sad_loc[(((__umul24(ty, 1)+tx)*1096)+search_pos)], GPUFI_DATATYPE_UNKNOWN);


            sad_loc[(((__umul24(ty, 1)+tx)*1096)+(search_pos+1))]=sad2;
            //GPUFI_KERNEL_VARIABLE(gpufi_dev, 60, "sad_loc[(((__umul24(ty, 1)+tx)*1096)+(search_pos+1))]", (int*)&sad_loc[(((__umul24(ty, 1)+tx)*1096)+(search_pos+1))], GPUFI_DATATYPE_UNKNOWN);


            sad_loc[(((__umul24(ty, 1)+tx)*1096)+(search_pos+2))]=sad3;
            //GPUFI_KERNEL_VARIABLE(gpufi_dev, 61, "sad_loc[(((__umul24(ty, 1)+tx)*1096)+(search_pos+2))]", (int*)&sad_loc[(((__umul24(ty, 1)+tx)*1096)+(search_pos+2))], GPUFI_DATATYPE_UNKNOWN);


            local_search_off_x+=3;
            GPUFI_KERNEL_VARIABLE(gpufi_dev, 62, "local_search_off_x", (int*)&local_search_off_x, GPUFI_DATATYPE_INTEGER);


            if ((local_search_off_x>=((2*16)+1)))
            {
                local_search_off_x-=((2*16)+1);
                GPUFI_KERNEL_VARIABLE(gpufi_dev, 63, "local_search_off_x", (int*)&local_search_off_x, GPUFI_DATATYPE_INTEGER);


                search_off_y ++ ;
                GPUFI_KERNEL_VARIABLE(gpufi_dev, 64, "search_off_y", (int*)&search_off_y, GPUFI_DATATYPE_INTEGER);
    ...
    */
    if (((threadIdx.x>>5)<(1*1)))
    {
        ...
        GPUFI_KERNEL_VARIABLE(gpufi_dev, 65, "tgroup", (int*)&tgroup, GPUFI_DATATYPE_INTEGER);


        int ty = ((threadIdx.x>>5)/1);
        GPUFI_KERNEL_VARIABLE(gpufi_dev, 66, "ty", (int*)&ty, GPUFI_DATATYPE_INTEGER);


        int tx = ((threadIdx.x>>5)-__umul24(ty, 1));
        GPUFI_KERNEL_VARIABLE(gpufi_dev, 67, "tx", (int*)&tx, GPUFI_DATATYPE_INTEGER);


        int index;
        GPUFI_KERNEL_VARIABLE(gpufi_dev, 68, "index", (int*)&index, GPUFI_DATATYPE_INTEGER);


        /* Macroblock and sub-block coordinates */
        int mb_x = ((tx+__umul24(bx, 1))>>2);
        GPUFI_KERNEL_VARIABLE(gpufi_dev, 69, "mb_x", (int*)&mb_x, GPUFI_DATATYPE_INTEGER);


        int mb_y = ((ty+__umul24(by, 1))>>2);
        GPUFI_KERNEL_VARIABLE(gpufi_dev, 70, "mb_y", (int*)&mb_y, GPUFI_DATATYPE_INTEGER);


        int block_x = ((tx+__umul24(bx, 1))&3);
        GPUFI_KERNEL_VARIABLE(gpufi_dev, 71, "block_x", (int*)&block_x, GPUFI_DATATYPE_INTEGER);


        int block_y = ((ty+__umul24(by, 1))&3);
        GPUFI_KERNEL_VARIABLE(gpufi_dev, 72, "block_y", (int*)&block_y, GPUFI_DATATYPE_INTEGER);
        ...
        if (((mb_x<mb_width)&&(mb_y<mb_height)))
        {
            ...
            */
            ...
            GPUFI_KERNEL_VARIABLE(gpufi_dev, 73, "blk_sad", (int*)&blk_sad, GPUFI_DATATYPE_UNKNOWN_POINTER);
            ...
            for (index=tgroup; index<(1096/4); index+=32)
            {
                ...
                GPUFI_KERNEL_VARIABLE(gpufi_dev, 76, "((struct vec8b * )blk_sad)[index]", (int*)&((struct vec8b * )blk_sad)[index], GPUFI_DATATYPE_UNKNOWN);
            ...
            GPUFI_KERNEL_VARIABLE(gpufi_dev, 75, "index", (int*)&index, GPUFI_DATATYPE_INTEGER);
