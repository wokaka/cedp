...
auto float energyvalx1 = (0.0F); 
auto float energyvalx2 = (0.0F); 
auto float energyvalx3 = (0.0F); 
auto float energyvalx4 = (0.0F); 
auto float energyvalx5 = (0.0F); 
auto float energyvalx6 = (0.0F); 
auto float energyvalx7 = (0.0F); 
auto float energyvalx8 = (0.0F); 
...
energyvalx1 += ((__shadow_var(,atominfo))[atomid]).w * ((1.0F) / sqrtf(dx1 * dx1 + dyz2)); 
energyvalx2 += ((__shadow_var(,atominfo))[atomid]).w * ((1.0F) / sqrtf(dx2 * dx2 + dyz2)); 
energyvalx3 += ((__shadow_var(,atominfo))[atomid]).w * ((1.0F) / sqrtf(dx3 * dx3 + dyz2)); 
energyvalx4 += ((__shadow_var(,atominfo))[atomid]).w * ((1.0F) / sqrtf(dx4 * dx4 + dyz2)); 
energyvalx5 += ((__shadow_var(,atominfo))[atomid]).w * ((1.0F) / sqrtf(dx5 * dx5 + dyz2)); 
energyvalx6 += ((__shadow_var(,atominfo))[atomid]).w * ((1.0F) / sqrtf(dx6 * dx6 + dyz2)); 
energyvalx7 += ((__shadow_var(,atominfo))[atomid]).w * ((1.0F) / sqrtf(dx7 * dx7 + dyz2)); 
energyvalx8 += ((__shadow_var(,atominfo))[atomid]).w * ((1.0F) / sqrtf(dx8 * dx8 + dyz2)); 
}  
