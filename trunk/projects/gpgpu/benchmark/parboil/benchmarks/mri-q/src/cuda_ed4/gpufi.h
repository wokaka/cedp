...
#define GPUFI_GLOBAL   			0		// define global variables
#define GPUFI_FUNC_INIT 		0		// define GPUFI_INIT function
#define GPUFI_FUNC_HALT 		0
#define GPUFI_FUNC_LIB			0
#define GPUFI_FUNC_KERNEL 	0
#define GPUFI_FUNC_LOOP 		0
#define GPUFI_FUNC_VARIABLE 0
