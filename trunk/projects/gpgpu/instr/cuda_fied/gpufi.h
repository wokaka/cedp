...
#define GPUFI_CHECK(n1,n2) { if(n1 != n2) GPUFI_EXIT(gpufi_dev);}
#define GPUFI_CHECK2(n1,n2,m1,m2) { if(n1!=n2 || m1!=m2) GPUFI_EXIT(gpufi_dev);}
#define GPUFI_CHECK3(n1,n2,m1,m2,l1,l2) { if(n1!=n2 || m1!=m2 || l1 != l2) GPUFI_EXIT(gpufi_dev);}
#define GPUFI_CHECK4(n1,n2,m1,m2,l1,l2,k1,k2) { if(n1!=n2 || m1!=m2 || l1 != l2 || k1 != k2) GPUFI_EXIT(gpufi_dev);}
...
__device__ int GPUFI_EXIT(struct _gpufi_data_ *gpufi_dev);
