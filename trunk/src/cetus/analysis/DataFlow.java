...
public class DataFlow {
    ...
    public static Set<Expression> getDefSet(BasicBlock block) {
        return null;
    }
    ...
    @SuppressWarnings("unused")
    public static Set<Expression> getUseSet(BasicBlock block) {
        return null;
    }

    public static Set<Expression> getUseSet(Traversable root) {
        return getUseSet(root, null);
    }
     ...
     */
    public static Set<Expression> getUseSet(Traversable root, Class<? extends Traversable> c) {
        ...
        for (;;) {
            ...
            if (o instanceof AccessExpression) {
                 ...
                 */
                Set<Expression> temp = getUseSet(expr.getLHS());
