...
public class CetusAnnotationParser
{
	...
	private	static HashMap<String, Object> cetus_map;
...
*/	
	...
	{
		Tools.println("CetusAnnotationParser is parsing [parallel] clause", 2);
	...
	{
		Tools.println("CetusAnnotationParser is parsing [use] clause", 2);
		match("(");
	...
	{
		Tools.println("CetusAnnotationParser is parsing [def] clause", 2);
		match("(");
		Set<String> set = new HashSet<String>();
		parse_commaSeparatedList(set);
		match(")");
	...
	{
		Tools.println("CetusAnnotationParser is parsing [private] clause", 2);
		match("(");
		Set<String> set = new HashSet<String>();
		parse_commaSeparatedList(set);
		match(")");
	...
	{
		Tools.println("CetusAnnotationParser is parsing [firstprivate] clause", 2);
		match("(");
		Set<String> set = new HashSet<String>();
		parse_commaSeparatedList(set);
		match(")");
	...
	{
		Tools.println("CetusAnnotationParser is parsing [lastprivate] clause", 2);
		match("(");
		Set<String> set = new HashSet<String>();
		parse_commaSeparatedList(set);
		match(")");
	...
	{
		Tools.println("CetusAnnotationParser is parsing [reduction] clause", 2);
		...
		for (String ikey : cetus_map.keySet())
		{
			if (ikey.compareTo("reduction") == 0)
			{
				reduction_map = (HashMap<String, Set<String>>)cetus_map.get(ikey);
				set = reduction_map.get(op);
				break;
			}
		}

		if (reduction_map == null) { reduction_map = new HashMap<String, Set<String>>(4); } 
	...
	private static void addToMap(String key, Set<String> new_set)
	{
		if (cetus_map.keySet().contains(key))
		{
			Set<String> set = (Set<String>)cetus_map.get(key);
			set.addAll(new_set);
		}
		else
		{
	...
	private static void addToMap(String key, Map<String, Set<String>> new_map)
	{
		if (cetus_map.keySet().contains(key))
		{
			Map<String, Set<String>> orig_map = (Map<String, Set<String>>)cetus_map.get(key);
