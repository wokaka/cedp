...
public class DDTestWrapper 
{
	...
	private static final int DDTEST_OMEGA = 2;
	private static final int DDTEST_RANGE = 3;
	...
	{		
		...
		Expression expr_diff = NormalExpression.subtract(subscript1, subscript2);		
...
*/				DV.add(dv);
	...
	private boolean testMIV (SubscriptPair pair, ArrayList<DependenceVector>dependence_vectors)
	{
		...
		if (ddtest_type == DDTEST_OMEGA)
		{
			...
			Tools.println("Error in data dependence testing", 0);
			System.exit(0);
		}
