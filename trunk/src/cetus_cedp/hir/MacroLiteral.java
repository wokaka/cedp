...
public class MacroLiteral extends Literal
{
  ...
  public Object clone()
  {
    MacroLiteral o = (MacroLiteral)super.clone();
    o.value = value;
    return o;
  }
   ...
   */
  public static void defaultPrint(MacroLiteral lit, OutputStream stream)
  {
